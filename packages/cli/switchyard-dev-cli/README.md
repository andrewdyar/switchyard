...
A command-line tool for local Switchyard development. When doing development work on
Switchyard core, this tool allows you to copy the changes to the various
Switchyard packages to Switchyard projects.

## Install

`npm install -g switchyard-dev-cli`

## Configuration / First time setup

The switchyard-dev-cli tool needs to know where your cloned Switchyard repository is
...
Navigate to the project you want to link to your forked Switchyard repository and
run:

`medusa-dev`

The tool will then scan your project's package.json to find its Switchyard
dependencies and copy the latest source from your cloned version of Switchyard into
...
Typically you'll also want to run `npm run watch` in the Switchyard repo to set up
watchers to build Switchyard source code.
...
`medusa-dev --packages @switchyard/medusa`

#### `--scan-once`

With this flag, the tool will do an initial scan and copy and then quit. This is
useful for setting up automated testing/builds of Switchyard projects from the latest
code.
