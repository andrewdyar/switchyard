...
import { PaymentEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Capture Payment Admin API Route](https://docs.switchyard.run/api/admin#payments_postpaymentsidcapture).
 *
