import type { PricingWorkflow } from "@switchyard/framework/types"
import {
  WorkflowData,
  WorkflowResponse,
  createWorkflow,
 ...
 * [Update Price Preference Admin API Route](https://docs.switchyard.run/api/admin#price-preferences_postpricepreferencesid).
 *
