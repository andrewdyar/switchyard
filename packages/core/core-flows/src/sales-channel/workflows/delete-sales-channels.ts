import { Modules, SalesChannelWorkflowEvents } from "@switchyard/framework/utils"
import {
  createWorkflow,
  transform,
  WorkflowData,
 ...
 * [Delete Sales Channel Admin API Route](https://docs.switchyard.run/api/admin#sales-channels_deletesaleschannelsid).
 * 
