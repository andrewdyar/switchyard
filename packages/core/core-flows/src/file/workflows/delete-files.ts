 ...
 * [Delete File Upload Admin API Route](https://docs.switchyard.run/api/admin#uploads_deleteuploadsid).
 * 
 * The [File Module Provider](https://docs.switchyard.run/resources/infrastructure-modules/file) installed
