import type { FileDTO } from "@switchyard/framework/types"
import {
  createWorkflow,
  WorkflowData,
  WorkflowResponse,
 ...
 * [File Module Provider](https://docs.switchyard.run/resources/infrastructure-modules/file). The workflow is used by the
 * [Upload Files Admin API Route](https://docs.switchyard.run/api/admin#uploads_postuploads).
 *
