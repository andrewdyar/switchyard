import { Modules, ProductTypeWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Types Admin API Route](https://docs.switchyard.run/api/admin#product-types_deleteproducttypesid).
 *
