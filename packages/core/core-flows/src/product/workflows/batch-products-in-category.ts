import type { ProductCategoryWorkflow } from "@switchyard/framework/types"
 ...
 * [Manage Products of Category Admin API Route](https://docs.switchyard.run/api/admin#product-categories_postproductcategoriesidproducts).
 *
