...
import { ProductCollectionWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Create Collection Admin API Route](https://docs.switchyard.run/api/admin#collections_postcollectionsid).
 *
