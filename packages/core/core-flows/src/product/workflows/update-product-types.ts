...
import { ProductTypeWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Update Product Type Admin API Route](https://docs.switchyard.run/api/admin#product-types_postproducttypesid).
 *
