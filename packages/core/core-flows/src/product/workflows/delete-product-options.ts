import { Modules, ProductOptionWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Product Option Admin API Route](https://docs.switchyard.run/api/admin#products_deleteproductsidoptionsoption_id).
 *
