import type { AdditionalData, ProductTypes } from "@switchyard/framework/types"
import { ProductOptionWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow updates one or more product options. It's used by the [Update Product Option Admin API Route](https://docs.switchyard.run/api/admin#products_postproductsidvariantsvariant_id).
 *
