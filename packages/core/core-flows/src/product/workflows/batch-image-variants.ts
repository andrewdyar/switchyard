...
import { ProductTypes } from "@switchyard/framework/types"
import {
 ...
 * It's used by the [Batch Image Variants Admin API Route](https://docs.switchyard.run/api/admin#products_postproductsidimagesimage_idvariantsbatch).
 *
