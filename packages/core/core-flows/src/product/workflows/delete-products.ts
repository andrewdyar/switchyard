import { Modules, ProductWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Delete Products Admin API Route](https://docs.switchyard.run/api/admin#products_deleteproductsid).
 *
