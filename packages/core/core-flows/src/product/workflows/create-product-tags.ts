...
import { ProductTagWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
 ...
 * [Create Product Tag Admin API Route](https://docs.switchyard.run/api/admin#product-tags_postproducttags).
 *
