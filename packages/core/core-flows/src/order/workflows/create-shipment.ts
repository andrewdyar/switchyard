...
/**
 * This workflow creates a shipment for an order. It's used by the [Create Order Shipment Admin API Route](https://docs.switchyard.run/api/admin#orders_postordersidfulfillmentsfulfillment_idshipments).
 *
