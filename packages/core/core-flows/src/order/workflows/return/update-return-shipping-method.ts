 ...
 * [Update Shipping Method Admin API Route](https://docs.switchyard.run/api/admin#returns_postreturnsidshippingmethodaction_id).
 *
 ...
 * 
 * ```ts
 * import { updateReturnShippingMethodWorkflow } from "@switchyard/core-flows";
