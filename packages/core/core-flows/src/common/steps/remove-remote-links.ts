import { DeleteEntityInput, Link } from "@switchyard/framework/modules-sdk"
 ...
 *
 * Learn more in the [Remote Link documentation](https://docs.switchyard.run/learn/fundamentals/module-links/remote-link#cascade-delete-linked-records)
 *
 * @example
