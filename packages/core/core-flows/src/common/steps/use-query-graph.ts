...
import { createStep, StepFunction, StepResponse } from "@switchyard/workflows-sdk"
 ...
 *
 * Learn more in the [Query documentation](https://docs.switchyard.run/learn/fundamentals/module-links/query).
 *
 * @example
