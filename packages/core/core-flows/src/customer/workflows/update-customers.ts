...
import { CustomerWorkflowEvents } from "@switchyard/framework/utils"
import {
  WorkflowData,
  WorkflowResponse,
  createHook,
...
/**
 * This workflow updates one or more customers. It's used by the [Update Customer Admin API Route](https://docs.switchyard.run/api/admin#customers_postcustomersid) and
 * the [Update Customer Store API Route](https://docs.switchyard.run/api/store#customers_postcustomersme).
 * 
