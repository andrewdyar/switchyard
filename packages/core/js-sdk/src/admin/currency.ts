...
export class Currency {
   ...
   * [List Currencies](https://docs.switchyard.run/api/admin#currencies_getcurrencies)
   * API route.
   * 
   ...
   * [Get Currency](https://docs.switchyard.run/api/admin#currencies_getcurrenciescode) API route.
   * 
