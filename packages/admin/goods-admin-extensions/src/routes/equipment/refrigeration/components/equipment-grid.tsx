...
import { Card, Heading, Text, Badge } from "@switchyard/ui"
import { Equipment, useEquipmentCurrentReadings } from "../../../../../../dashboard/src/hooks/api/equipment"
...
const EquipmentCard = ({ equipment, onClick }: EquipmentCardProps) => {
  const { temperature, humidity, isLoading } = useEquipmentCurrentReadings(equipment.id)
  ...
  return (
    <Card
      className="p-4 cursor-pointer hover:bg-ui-bg-subtle-hover transition-colors"
      onClick={onClick}
    >
