...
import { Equipment, useEquipmentTimeSeries, useEquipmentAlerts } from "../../../../../../dashboard/src/hooks/api/equipment"
...
export const EquipmentDetailModal = ({ equipment, onClose }: EquipmentDetailModalProps) => {
  ...
  const { readings, isLoading } = useEquipmentTimeSeries(
    equipment.id,
  ...
  return (
    <Drawer open={true} onOpenChange={(open) => !open && onClose()}>
      <Drawer.Content className="max-w-6xl">
        <Drawer.Header>
                      ...
                      {alerts.map((alert) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div>
                              <Text weight="plus">{alert.alert_type}</Text>
