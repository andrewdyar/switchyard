...
flowchart TB
    ...
    subgraph Supabase [Supabase Tables]
        SP[source_products<br/>Product catalog]
        GRM[goods_retailer_mapping<br/>Availability per store]
        GRP[goods_retailer_pricing<br/>Price history]
    end
    
    subgraph Dashboard [Admin Dashboard]
        ScrapedPage[Scraped Products<br/>Monitor all products]
        ProductsPage[Products<br/>Sellable catalog]
    end
