...
While Switchyard inherits the full Medusa Admin API, these are the endpoints actively used in our operations:
...
These Medusa endpoints are included for completeness but are not used in Switchyard operations:
