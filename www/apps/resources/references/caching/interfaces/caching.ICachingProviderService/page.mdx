...
If you're creating a client or establishing a connection with a third-party service, do it in a [Loader](https://docs.switchyard.com/learn/fundamentals/modules/loaders)
and store it in the Module's container. Then, you can access it in your service using the container.

:::note[Loader Example]

[Initialize MongoDB client in loader and access it in service](https://docs.switchyard.com/learn/fundamentals/modules/loaders#example-register-custom-mongodb-connection).
