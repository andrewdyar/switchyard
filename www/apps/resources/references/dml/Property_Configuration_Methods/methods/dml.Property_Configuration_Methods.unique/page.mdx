...
<TypeList types={[{"name":"name","type":"`string`","description":"The unique index's name. If not provided,\nSwitchyard generates the name.","optional":true,"defaultValue":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="unique"/>
