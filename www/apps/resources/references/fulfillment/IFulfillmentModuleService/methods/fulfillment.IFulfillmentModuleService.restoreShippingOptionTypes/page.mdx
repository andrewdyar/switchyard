...
slug: /references/fulfillment/restoreShippingOptionTypes
sidebar_label: restoreShippingOptionTypes
---

import { TypeList } from "docs-ui"

# restoreShippingOptionTypes - Fulfillment Module Reference

This documentation provides a reference to the `restoreShippingOptionTypes` method. This belongs to the Fulfillment Module.
