...
slug: /references/product/softDeleteProductTags
sidebar_label: softDeleteProductTags
---

import { TypeList } from "docs-ui"

# softDeleteProductTags - Product Module Reference

This documentation provides a reference to the `softDeleteProductTags` method. This belongs to the Product Module.
...
This method is used to delete tags. Unlike the delete method, this method won't completely remove the tag. It can still be accessed or retrieved using methods like retrieve if you pass the `withDeleted` property to the `config` object parameter.
