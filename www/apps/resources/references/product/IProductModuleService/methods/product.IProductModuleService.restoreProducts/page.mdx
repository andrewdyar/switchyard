...
slug: /references/product/restoreProducts
sidebar_label: restoreProducts
---

import { TypeList } from "docs-ui"

# restoreProducts - Product Module Reference

This documentation provides a reference to the `restoreProducts` method. This belongs to the Product Module.
