...
slug: /references/product/restoreProductTypes
sidebar_label: restoreProductTypes
---

import { TypeList } from "docs-ui"

# restoreProductTypes - Product Module Reference

This documentation provides a reference to the `restoreProductTypes` method. This belongs to the Product Module.
...
This method is used to restore types which were deleted using the softDelete method.
