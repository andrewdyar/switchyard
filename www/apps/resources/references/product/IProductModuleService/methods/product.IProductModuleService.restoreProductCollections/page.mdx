...
slug: /references/product/restoreProductCollections
sidebar_label: restoreProductCollections
---

import { TypeList } from "docs-ui"

# restoreProductCollections - Product Module Reference

This documentation provides a reference to the `restoreProductCollections` method. This belongs to the Product Module.
...
This method is used to restore collections which were deleted using the softDelete method.
