...
slug: /references/product/restoreProductCategories
sidebar_label: restoreProductCategories
---

import { TypeList } from "docs-ui"

# restoreProductCategories - Product Module Reference

This documentation provides a reference to the `restoreProductCategories` method. This belongs to the Product Module.
...
This method is used to restore categories which were deleted using the softDelete method.
