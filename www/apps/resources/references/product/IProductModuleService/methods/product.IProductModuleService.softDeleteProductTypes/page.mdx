...
slug: /references/product/softDeleteProductTypes
sidebar_label: softDeleteProductTypes
---

import { TypeList } from "docs-ui"

# softDeleteProductTypes - Product Module Reference

This documentation provides a reference to the `softDeleteProductTypes` method. This belongs to the Product Module.
...
This method is used to delete types. Unlike the delete method, this method won't completely remove the type. It can still be accessed or retrieved using methods like retrieve if you pass the `withDeleted` property to the `config` object parameter.

The soft-deleted types can be restored using the restore method.
