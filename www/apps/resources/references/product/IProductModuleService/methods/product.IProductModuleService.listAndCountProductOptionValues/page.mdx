...
slug: /references/product/listAndCountProductOptionValues
sidebar_label: listAndCountProductOptionValues
---
...
This documentation provides a reference to the `listAndCountProductOptionValues` method. This belongs to the Product Module.
