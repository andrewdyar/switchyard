...
This reference shows all the events emitted by the Switchyard application related to the Fulfillment Module. If you use the module outside the Switchyard application, these events aren't emitted.
