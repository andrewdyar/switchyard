...
slug: /references/stock-location-next/softDeleteStockLocations
sidebar_label: softDeleteStockLocations
---

import { TypeList } from "docs-ui"

# softDeleteStockLocations - Stock Location Next Module Reference

This documentation provides a reference to the `softDeleteStockLocations` method. This belongs to the Stock Location Next Module.
