...
slug: /references/order/restoreReturns
sidebar_label: restoreReturns
---

import { TypeList } from "docs-ui"

# restoreReturns - Order Module Reference

This documentation provides a reference to the `restoreReturns` method. This belongs to the Order Module.
