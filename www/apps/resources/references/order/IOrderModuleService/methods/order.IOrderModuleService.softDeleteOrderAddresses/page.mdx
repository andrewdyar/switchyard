...
slug: /references/order/softDeleteOrderAddresses
sidebar_label: softDeleteOrderAddresses
---

import { TypeList } from "docs-ui"

# softDeleteOrderAddresses - Order Module Reference

This documentation provides a reference to the `softDeleteOrderAddresses` method. This belongs to the Order Module.
