...
slug: /references/order/previewOrderChange
sidebar_label: previewOrderChange
---
...
This documentation provides a reference to the `previewOrderChange` method. This belongs to the Order Module.
