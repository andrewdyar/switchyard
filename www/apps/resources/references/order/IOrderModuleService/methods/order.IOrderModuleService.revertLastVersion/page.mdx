...
slug: /references/order/revertLastVersion
sidebar_label: revertLastVersion
---
...
This documentation provides a reference to the `revertLastVersion` method. This belongs to the Order Module.
