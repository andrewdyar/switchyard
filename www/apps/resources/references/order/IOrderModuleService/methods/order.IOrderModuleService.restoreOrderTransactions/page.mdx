...
slug: /references/order/restoreOrderTransactions
sidebar_label: restoreOrderTransactions
---

import { TypeList } from "docs-ui"

# restoreOrderTransactions - Order Module Reference

This documentation provides a reference to the `restoreOrderTransactions` method. This belongs to the Order Module.
