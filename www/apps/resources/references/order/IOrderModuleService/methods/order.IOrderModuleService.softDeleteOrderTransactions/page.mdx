...
slug: /references/order/softDeleteOrderTransactions
sidebar_label: softDeleteOrderTransactions
---

import { TypeList } from "docs-ui"

# softDeleteOrderTransactions - Order Module Reference

This documentation provides a reference to the `softDeleteOrderTransactions` method. This belongs to the Order Module.
