...
slug: /references/order/retrieveReturn
sidebar_label: retrieveReturn
---

import { TypeList } from "docs-ui"

# retrieveReturn - Order Module Reference

This documentation provides a reference to the `retrieveReturn` method. This belongs to the Order Module.
