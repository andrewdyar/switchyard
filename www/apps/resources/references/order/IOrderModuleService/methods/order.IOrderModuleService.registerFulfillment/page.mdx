...
slug: /references/order/registerFulfillment
sidebar_label: registerFulfillment
---

import { TypeList } from "docs-ui"

# registerFulfillment - Order Module Reference

This documentation provides a reference to the `registerFulfillment` method. This belongs to the Order Module.
