...
slug: /references/order/listOrderLineItemAdjustments
sidebar_label: listOrderLineItemAdjustments
---

import { TypeList } from "docs-ui"

# listOrderLineItemAdjustments - Order Module Reference

This documentation provides a reference to the `listOrderLineItemAdjustments` method. This belongs to the Order Module.
