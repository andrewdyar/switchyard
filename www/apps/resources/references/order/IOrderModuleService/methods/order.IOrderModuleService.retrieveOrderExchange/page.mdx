...
slug: /references/order/retrieveOrderExchange
sidebar_label: retrieveOrderExchange
---
...
This documentation provides a reference to the `retrieveOrderExchange` method. This belongs to the Order Module.
