...
slug: /references/order/softDeleteOrderLineItems
sidebar_label: softDeleteOrderLineItems
---

import { TypeList } from "docs-ui"

# softDeleteOrderLineItems - Order Module Reference

This documentation provides a reference to the `softDeleteOrderLineItems` method. This belongs to the Order Module.
