...
slug: /references/order/cancelFulfillment
sidebar_label: cancelFulfillment
---
...
This documentation provides a reference to the `cancelFulfillment` method. This belongs to the Order Module.
