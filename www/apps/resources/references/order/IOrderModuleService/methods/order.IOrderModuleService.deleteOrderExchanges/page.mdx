...
slug: /references/order/deleteOrderExchanges
sidebar_label: deleteOrderExchanges
---
...
This documentation provides a reference to the `deleteOrderExchanges` method. This belongs to the Order Module.
