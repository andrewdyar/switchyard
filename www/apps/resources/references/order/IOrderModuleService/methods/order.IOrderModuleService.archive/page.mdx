...
This documentation provides a reference to the `archive` method. This belongs to the Order Module.
...
## archive(orderIds, sharedContext?): Promise&#60;[OrderDTO](../../../interfaces/order.OrderDTO/page.mdx)[]&#62;
...
<TypeList types={[{"name":"Promise","type":"Promise&#60;[OrderDTO](../../../interfaces/order.OrderDTO/page.mdx)&#62;","optional":false,"defaultValue":"","description":"The archived order.","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="archive"/>
