...
slug: /references/order/restoreOrderShippingMethods
sidebar_label: restoreOrderShippingMethods
---

import { TypeList } from "docs-ui"

# restoreOrderShippingMethods - Order Module Reference

This documentation provides a reference to the `restoreOrderShippingMethods` method. This belongs to the Order Module.
