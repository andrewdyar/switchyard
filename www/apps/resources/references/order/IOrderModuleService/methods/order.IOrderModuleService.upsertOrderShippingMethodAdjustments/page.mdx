...
slug: /references/order/upsertOrderShippingMethodAdjustments
sidebar_label: upsertOrderShippingMethodAdjustments
---
...
This documentation provides a reference to the `upsertOrderShippingMethodAdjustments` method. This belongs to the Order Module.
