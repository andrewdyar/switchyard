...
slug: /references/order/listOrderAddresses
sidebar_label: listOrderAddresses
---

import { TypeList } from "docs-ui"

# listOrderAddresses - Order Module Reference

This documentation provides a reference to the `listOrderAddresses` method. This belongs to the Order Module.
