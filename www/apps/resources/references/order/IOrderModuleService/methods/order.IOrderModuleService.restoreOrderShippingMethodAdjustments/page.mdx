...
slug: /references/order/restoreOrderShippingMethodAdjustments
sidebar_label: restoreOrderShippingMethodAdjustments
---

import { TypeList } from "docs-ui"

# restoreOrderShippingMethodAdjustments - Order Module Reference

This documentation provides a reference to the `restoreOrderShippingMethodAdjustments` method. This belongs to the Order Module.
