...
slug: /references/order/deleteReturnItems
sidebar_label: deleteReturnItems
---

import { TypeList } from "docs-ui"

# deleteReturnItems - Order Module Reference

This documentation provides a reference to the `deleteReturnItems` method. This belongs to the Order Module.
