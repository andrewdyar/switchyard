...
slug: /references/order/receiveReturn
sidebar_label: receiveReturn
---
...
This documentation provides a reference to the `receiveReturn` method. This belongs to the Order Module.
