...
slug: /references/order/softDeleteReturns
sidebar_label: softDeleteReturns
---

import { TypeList } from "docs-ui"

# softDeleteReturns - Order Module Reference

This documentation provides a reference to the `softDeleteReturns` method. This belongs to the Order Module.
