...
sidebar_label: softDeleteOrderClaims
---

import { TypeList } from "docs-ui"

# softDeleteOrderClaims - Order Module Reference

This documentation provides a reference to the `softDeleteOrderClaims` method. This belongs to the Order Module.
