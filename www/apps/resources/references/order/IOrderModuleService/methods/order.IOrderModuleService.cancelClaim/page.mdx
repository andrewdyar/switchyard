...
slug: /references/order/cancelClaim
sidebar_label: cancelClaim
---

import { TypeList } from "docs-ui"

# cancelClaim - Order Module Reference

This documentation provides a reference to the `cancelClaim` method. This belongs to the Order Module.
