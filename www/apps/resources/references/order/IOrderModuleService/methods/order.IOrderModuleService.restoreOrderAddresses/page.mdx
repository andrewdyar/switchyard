...
slug: /references/order/restoreOrderAddresses
sidebar_label: restoreOrderAddresses
---

import { TypeList } from "docs-ui"

# restoreOrderAddresses - Order Module Reference

This documentation provides a reference to the `restoreOrderAddresses` method. This belongs to the Order Module.
