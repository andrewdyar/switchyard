...
slug: /references/order/deleteOrderClaims
sidebar_label: deleteOrderClaims
---

import { TypeList } from "docs-ui"

# deleteOrderClaims - Order Module Reference

This documentation provides a reference to the `deleteOrderClaims` method. This belongs to the Order Module.
