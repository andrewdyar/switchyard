...
slug: /references/order/listAndCountReturns
sidebar_label: listAndCountReturns
---

import { TypeList } from "docs-ui"

# listAndCountReturns - Order Module Reference

This documentation provides a reference to the `listAndCountReturns` method. This belongs to the Order Module.
