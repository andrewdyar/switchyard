...
slug: /references/order/restoreOrderLineItemAdjustments
sidebar_label: restoreOrderLineItemAdjustments
---

import { TypeList } from "docs-ui"

# restoreOrderLineItemAdjustments - Order Module Reference

This documentation provides a reference to the `restoreOrderLineItemAdjustments` method. This belongs to the Order Module.
