...
slug: /references/order/upsertOrderLineItemAdjustments
sidebar_label: upsertOrderLineItemAdjustments
---
...
This documentation provides a reference to the `upsertOrderLineItemAdjustments` method. This belongs to the Order Module.
