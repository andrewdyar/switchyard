...
slug: /references/order/upsertOrderShippingMethodTaxLines
sidebar_label: upsertOrderShippingMethodTaxLines
---

import { TypeList } from "docs-ui"

# upsertOrderShippingMethodTaxLines - Order Module Reference

This documentation provides a reference to the `upsertOrderShippingMethodTaxLines` method. This belongs to the Order Module.
