...
slug: /references/order/restoreOrderExchanges
sidebar_label: restoreOrderExchanges
---

import { TypeList } from "docs-ui"

# restoreOrderExchanges - Order Module Reference

This documentation provides a reference to the `restoreOrderExchanges` method. This belongs to the Order Module.
