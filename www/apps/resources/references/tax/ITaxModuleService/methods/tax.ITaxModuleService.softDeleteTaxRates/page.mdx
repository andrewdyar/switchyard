...
slug: /references/tax/softDeleteTaxRates
sidebar_label: softDeleteTaxRates
---

import { TypeList } from "docs-ui"

# softDeleteTaxRates - Tax Module Reference

This documentation provides a reference to the `softDeleteTaxRates` method. This belongs to the Tax Module.
