...
slug: /references/tax/retrieveTaxRate
sidebar_label: retrieveTaxRate
---
...
This documentation provides a reference to the `retrieveTaxRate` method. This belongs to the Tax Module.
