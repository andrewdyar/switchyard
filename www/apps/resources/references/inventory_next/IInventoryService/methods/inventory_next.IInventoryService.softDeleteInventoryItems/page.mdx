...
slug: /references/inventory-next/softDeleteInventoryItems
sidebar_label: softDeleteInventoryItems
---
...
This documentation provides a reference to the `softDeleteInventoryItems` method. This belongs to the Inventory Next Module.
