...
slug: /references/inventory-next/softDeleteReservationItems
sidebar_label: softDeleteReservationItems
---

import { TypeList } from "docs-ui"

# softDeleteReservationItems - Inventory Next Module Reference

This documentation provides a reference to the `softDeleteReservationItems` method. This belongs to the Inventory Next Module.
