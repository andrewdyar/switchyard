...
slug: /references/promotion/softDeletePromotions
sidebar_label: softDeletePromotions
---

import { TypeList } from "docs-ui"

# softDeletePromotions - Promotion Module Reference

This documentation provides a reference to the `softDeletePromotions` method. This belongs to the Promotion Module.
