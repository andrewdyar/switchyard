...
The constructor allows you to access resources from the [module's container](https://docs.switchyard.com/learn/fundamentals/modules/container)
...
<TypeList types={[{"name":"TConfig","type":"`object`","description":"The type of the provider's options passed as a second parameter.","optional":true,"defaultValue":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="AbstractPaymentProvider"/>
...
![Diagram showcasing authorize payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747307795/Switchyard%20Resources/authorize-payment\_qzpy6e.jpg)
...
![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747309278/Switchyard%20Resources/authorize-data\_erjg7r.jpg)
...
![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310189/Switchyard%20Resources/cancel-data\_gzcgbc.jpg)
...
<TypeList types={[{"name":"input","type":"[CancelPaymentInput](../../../types/interfaces/types.CancelPaymentInput/page.mdx)","description":"The input to cancel the payment. The `data` field should contain the data from the payment provider. when the payment was created.","optional":false,"defaultValue":"","expandable":false,"children":[{"name":"data","type":"`Record<string, unknown>`","description":"Data is a combination of the input from the user and what is stored in the database for the associated model.","optional":true,"defaultValue":"","expandable":false,"children":[]},{"name":"context","type":"[PaymentProviderContext](../../../types/interfaces/types.PaymentProviderContext/page.mdx)","description":"The context for this payment operation. The data is guaranteed to be validated and not directly provided by the user.","optional":true,"defaultValue":"","expandable":false,"children":[]}]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="cancelPayment"/>
...
![Diagram showcasing capture payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747307414/Switchyard%20Resources/Klarna\_Payment\_Graphic\_2025\_1\_lii7bw.jpg)
...
![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747309870/Switchyard%20Resources/capture-data\_acgdhf.jpg)
...
This method is used when creating an account holder in Switchyard, allowing you to create
...
The returned data will be stored in the account holder created in Switchyard. For example,
...
This is available starting from [Switchyard v2.5.0](https://github.com/switchyard/medusa/releases/tag/v2.5.0).
...
This method is used when an account holder is deleted in Switchyard, allowing you
...
![Diagram showcasing delete payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311084/Switchyard%20Resources/delete-payment\_smxsiq.jpg)
...
![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311084/Switchyard%20Resources/delete-data\_xg65ck.jpg)
...
Learn more in the [Webhook Events](https://docs.switchyard.com/resources/commerce-modules/payment/webhook-events) documentation.
...
![Diagram showcasing initiate payment flow](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310624/Switchyard%20Resources/initiate-payment\_dpoa2g.jpg)
...
![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747310699/Switchyard%20Resources/initiate-data\_ikc05t.jpg)
...
![Diagram showcasing data flow between methods](https://res.cloudinary.com/dza7lstvk/image/upload/v1747311296/Switchyard%20Resources/refund-data\_plcjl0.jpg)
...
This method is used when retrieving an account holder in Switchyard, allowing you to retrieve
the equivalent account in the third-party payment provider. An account holder is useful to
later save payment methods, such as credit cards, for a customer in the
third-party payment provider using the [savePaymentMethod](../../../types/interfaces/types.IPaymentProvider/page.mdx#savepaymentmethod) method.
...
This is available starting from [Switchyard v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0).
...
This method is used when updating an account holder in Switchyard, allowing you to update
...
This is available starting from [Switchyard v2.5.1](https://github.com/switchyard/medusa/releases/tag/v2.5.1).
...
<TypeList types={[{"name":"options","type":"`Record<any, any>`","description":"The provider's options passed in `switchyard.config.ts`.","optional":false,"defaultValue":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="validateOptions"/>
