...
slug: /references/cart/softDeleteLineItemAdjustments
sidebar_label: softDeleteLineItemAdjustments
---

import { TypeList } from "docs-ui"

# softDeleteLineItemAdjustments - Cart Module Reference

This documentation provides a reference to the `softDeleteLineItemAdjustments` method. This belongs to the Cart Module.
