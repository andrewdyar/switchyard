...
# createCustomerAddressesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createCustomerAddressesStep`. It belongs to the `@switchyard/medusa/core-flows` package.
