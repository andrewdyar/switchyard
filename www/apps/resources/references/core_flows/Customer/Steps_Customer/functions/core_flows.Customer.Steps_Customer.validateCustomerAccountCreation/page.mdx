...
# validateCustomerAccountCreation - Switchyard Core Workflows Reference

This documentation provides a reference to the `validateCustomerAccountCreation`. It belongs to the `@switchyard/medusa/core-flows` package.
