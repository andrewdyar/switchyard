...
# notifyOnFailureStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `notifyOnFailureStep`. It belongs to the `@switchyard/medusa/core-flows` package.
