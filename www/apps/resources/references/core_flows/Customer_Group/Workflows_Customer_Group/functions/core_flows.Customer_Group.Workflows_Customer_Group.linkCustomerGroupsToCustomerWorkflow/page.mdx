...
# linkCustomerGroupsToCustomerWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `linkCustomerGroupsToCustomerWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow manages the customer groups a customer is in. It's used by the
[Manage Groups of Customer Admin API Route](https://docs.switchyard.com/api/admin#customers\_postcustomersidcustomergroups).

You can use this workflow within your customizations or your own custom workflows, allowing you to
manage the customer groups of a customer in your custom flow.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/customer-group/workflows/link-customer-groups-customer.ts#L37" />
...
import { linkCustomerGroupsToCustomerWorkflow } from "@switchyard/medusa/core-flows"
