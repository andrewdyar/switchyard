...
# createCustomerGroupsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createCustomerGroupsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more customer groups. It's used by the
[Create Customer Group Admin API Route](https://docs.switchyard.com/api/admin#customer-groups\_postcustomergroups).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/customer-group/workflows/create-customer-groups.ts#L52" />
...
import { createCustomerGroupsWorkflow } from "@switchyard/medusa/core-flows"
