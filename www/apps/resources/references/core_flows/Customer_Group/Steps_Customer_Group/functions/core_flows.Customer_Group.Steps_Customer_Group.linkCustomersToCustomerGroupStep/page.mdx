...
# linkCustomersToCustomerGroupStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `linkCustomersToCustomerGroupStep`. It belongs to the `@switchyard/medusa/core-flows` package.
