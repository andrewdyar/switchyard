...
# createInventoryLevelsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createInventoryLevelsStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step creates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { createInventoryLevelsStep } from "@switchyard/medusa/core-flows"
