...
# createInventoryItemsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createInventoryItemsStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step creates one or more inventory items.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { createInventoryItemsStep } from "@switchyard/medusa/core-flows"
