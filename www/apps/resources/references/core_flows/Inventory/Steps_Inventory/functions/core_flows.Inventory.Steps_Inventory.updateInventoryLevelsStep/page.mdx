...
# updateInventoryLevelsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateInventoryLevelsStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step updates one or more inventory levels.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { updateInventoryLevelsStep } from "@switchyard/medusa/core-flows"
