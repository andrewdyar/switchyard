...
# validateSalesChannelsExistStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `validateSalesChannelsExistStep`. It belongs to the `@switchyard/medusa/core-flows` package.
...
import { validateSalesChannelsExistStep } from "@switchyard/medusa/core-flows"
