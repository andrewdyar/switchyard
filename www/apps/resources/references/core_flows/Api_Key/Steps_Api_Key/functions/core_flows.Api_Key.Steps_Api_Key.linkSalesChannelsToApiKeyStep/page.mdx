...
# linkSalesChannelsToApiKeyStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `linkSalesChannelsToApiKeyStep`. It belongs to the `@switchyard/medusa/core-flows` package.
