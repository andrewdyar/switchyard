...
# updateApiKeysWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateApiKeysWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates one or more secret or publishable API keys. It's used by the
[Update API Key Admin API Route](https://docs.switchyard.com/api/admin#api-keys\_postapikeysid).

You can use this workflow within your customizations or your own custom workflows, allowing you to
update API keys within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/api-key/workflows/update-api-keys.ts#L57" />
...
import { updateApiKeysWorkflow } from "@switchyard/medusa/core-flows"
