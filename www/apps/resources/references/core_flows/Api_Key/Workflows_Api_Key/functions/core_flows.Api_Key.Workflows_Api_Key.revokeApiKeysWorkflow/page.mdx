...
# revokeApiKeysWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `revokeApiKeysWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.
...
This workflow is used by the [Revoke API Key API Route](https://docs.switchyard.com/api/admin#api-keys\_postapikeysidrevoke).

You can use this workflow within your customizations or your own custom workflows, allowing you to
revoke API keys within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/api-key/workflows/revoke-api-keys.ts#L59" />
...
import { revokeApiKeysWorkflow } from "@switchyard/medusa/core-flows"
