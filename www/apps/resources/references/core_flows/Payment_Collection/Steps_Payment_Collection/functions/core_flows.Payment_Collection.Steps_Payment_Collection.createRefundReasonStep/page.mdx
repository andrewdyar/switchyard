...
# createRefundReasonStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createRefundReasonStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step creates one or more refund reasons.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { createRefundReasonStep } from "@switchyard/medusa/core-flows"
