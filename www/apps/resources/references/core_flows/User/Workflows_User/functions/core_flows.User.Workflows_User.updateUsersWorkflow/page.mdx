...
# updateUsersWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateUsersWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates one or more users. It's used by the
[Update User Admin API Route](https://docs.switchyard.com/api/admin#users\_postusersid).

You can use this workflow within your customizations or your own custom workflows, allowing you to
update users within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/user/workflows/update-users.ts#L37" />
...
import { updateUsersWorkflow } from "@switchyard/medusa/core-flows"
