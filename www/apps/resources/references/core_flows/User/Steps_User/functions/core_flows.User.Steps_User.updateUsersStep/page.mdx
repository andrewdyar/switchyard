...
# updateUsersStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateUsersStep`. It belongs to the `@switchyard/medusa/core-flows` package.
