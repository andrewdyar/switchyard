...
# deleteProductCategoriesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteProductCategoriesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more product categories. It's used by the
[Delete Product Category Admin API Route](https://docs.switchyard.com/api/admin#product-categories\_deleteproductcategoriesid).

You can use this workflow within your customizations or your own custom workflows, allowing you to
delete product categories within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product-category/workflows/delete-product-categories.ts#L39" />
...
import { deleteProductCategoriesWorkflow } from "@switchyard/medusa/core-flows"
