...
# createShippingProfilesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createShippingProfilesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more shipping profiles. It's used by the
[Create Shipping Profile Admin API Route](https://docs.switchyard.com/api/admin#shipping-profiles\_postshippingprofiles).

You can use this workflow within your own customizations or custom workflows, allowing you to
create shipping profiles within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/fulfillment/workflows/create-shipping-profiles.ts#L35" />
...
import { createShippingProfilesWorkflow } from "@switchyard/medusa/core-flows"
