...
# validateShippingOptionPricesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `validateShippingOptionPricesStep`. It belongs to the `@switchyard/medusa/core-flows` package.
