...
# setShippingOptionsPricesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `setShippingOptionsPricesStep`. It belongs to the `@switchyard/medusa/core-flows` package.
