...
# deleteTaxRegionsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteTaxRegionsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more tax regions. It's used by the
[Delete Tax Region Admin API Route](https://docs.switchyard.com/api/admin#tax-regions\_deletetaxregionsid).

You can use this workflow within your own customizations or custom workflows, allowing you
to delete tax regions in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/tax/workflows/delete-tax-regions.ts#L38" />
...
import { deleteTaxRegionsWorkflow } from "@switchyard/medusa/core-flows"
