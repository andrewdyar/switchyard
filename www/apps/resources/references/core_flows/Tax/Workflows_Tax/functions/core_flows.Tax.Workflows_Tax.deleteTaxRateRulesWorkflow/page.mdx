...
# deleteTaxRateRulesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteTaxRateRulesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more tax rate rules. It's used by the
[Remove Rule of Tax Rate Admin API Route](https://docs.switchyard.com/api/admin#tax-rates\_deletetaxratesidrulesrule\_id).

You can use this workflow within your own customizations or custom workflows, allowing you
to delete tax rate rules in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/tax/workflows/delete-tax-rate-rules.ts#L38" />
...
import { deleteTaxRateRulesWorkflow } from "@switchyard/medusa/core-flows"
