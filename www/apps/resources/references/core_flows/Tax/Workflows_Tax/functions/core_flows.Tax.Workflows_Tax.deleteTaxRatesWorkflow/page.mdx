...
# deleteTaxRatesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteTaxRatesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more tax rates. It's used by the
[Delete Tax Rates Admin API Route](https://docs.switchyard.com/api/admin#tax-rates\_deletetaxratesid).

You can use this workflow within your own customizations or custom workflows, allowing you
to delete tax rates in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/tax/workflows/delete-tax-rates.ts#L38" />
...
import { deleteTaxRatesWorkflow } from "@switchyard/medusa/core-flows"
