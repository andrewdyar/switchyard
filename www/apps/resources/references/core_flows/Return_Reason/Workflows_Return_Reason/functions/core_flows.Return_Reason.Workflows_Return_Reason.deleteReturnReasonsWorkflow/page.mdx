...
# deleteReturnReasonsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteReturnReasonsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more return reasons. It's used by the
[Delete Return Reasons Admin API Route](https://docs.switchyard.com/api/admin#return-reasons\_deletereturnreasonsid).

You can use this workflow within your customizations or your own custom workflows, allowing you to
delete return reasons within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/return-reason/workflows/delete-return-reasons.ts#L36" />
...
import { deleteReturnReasonsWorkflow } from "@switchyard/medusa/core-flows"
