...
# removeRemoteLinkStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `removeRemoteLinkStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step deletes linked records of a record.

Learn more in the [Remote Link documentation](https://docs.switchyard.com/learn/fundamentals/module-links/remote-link#cascade-delete-linked-records)
...
<TypeList types={[{"name":"RemoveRemoteLinksStepInput","type":"`RemoveRemoteLinksStepInput`","optional":false,"defaultValue":"","description":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="removeRemoteLinkStep"/>
