...
# createDefaultStoreStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createDefaultStoreStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step creates a default store. Useful if creating a workflow
that seeds data into Switchyard.
...
<TypeList types={[{"name":"CreateDefaultStoreStepInput","type":"`CreateDefaultStoreStepInput`","optional":false,"defaultValue":"","description":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="createDefaultStoreStep"/>
