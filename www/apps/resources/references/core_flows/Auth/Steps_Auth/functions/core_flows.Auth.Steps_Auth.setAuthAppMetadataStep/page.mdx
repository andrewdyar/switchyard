...
# setAuthAppMetadataStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `setAuthAppMetadataStep`. It belongs to the `@switchyard/medusa/core-flows` package.
