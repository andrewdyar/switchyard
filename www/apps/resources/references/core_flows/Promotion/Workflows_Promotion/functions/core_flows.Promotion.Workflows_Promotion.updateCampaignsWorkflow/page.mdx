...
# updateCampaignsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateCampaignsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates one or more campaigns. It's used by the [Update Campaign Admin API Route](https://docs.switchyard.com/api/admin#campaigns\_postcampaignsid).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/promotion/workflows/update-campaigns.ts#L55" />
...
import { updateCampaignsWorkflow } from "@switchyard/medusa/core-flows"
