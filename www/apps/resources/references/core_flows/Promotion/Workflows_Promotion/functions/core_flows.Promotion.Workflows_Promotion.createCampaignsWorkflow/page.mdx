...
# createCampaignsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createCampaignsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more campaigns. It's used by the [Create Campaign Admin API Route](https://docs.switchyard.com/api/admin#campaigns\_postcampaigns).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/promotion/workflows/create-campaigns.ts#L60" />
...
import { createCampaignsWorkflow } from "@switchyard/medusa/core-flows"
