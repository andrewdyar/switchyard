...
# createPromotionsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createPromotionsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more promotions. It's used by the [Create Promotion Admin API Route](https://docs.switchyard.com/api/admin#promotions\_postpromotions).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/promotion/workflows/create-promotions.ts#L62" />
