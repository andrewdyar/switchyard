...
# addRulesToPromotionsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `addRulesToPromotionsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
