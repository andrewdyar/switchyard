...
# updatePromotionRulesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `updatePromotionRulesStep`. It belongs to the `@switchyard/medusa/core-flows` package.
