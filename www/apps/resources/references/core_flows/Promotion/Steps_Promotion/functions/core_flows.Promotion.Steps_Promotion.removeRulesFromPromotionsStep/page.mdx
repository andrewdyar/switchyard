...
# removeRulesFromPromotionsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `removeRulesFromPromotionsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
