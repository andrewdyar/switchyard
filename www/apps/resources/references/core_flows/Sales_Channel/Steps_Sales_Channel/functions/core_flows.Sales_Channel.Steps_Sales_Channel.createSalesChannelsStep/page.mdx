...
# createSalesChannelsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createSalesChannelsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
