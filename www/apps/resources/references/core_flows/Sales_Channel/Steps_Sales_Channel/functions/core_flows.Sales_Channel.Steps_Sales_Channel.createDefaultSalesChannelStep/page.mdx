...
# createDefaultSalesChannelStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createDefaultSalesChannelStep`. It belongs to the `@switchyard/medusa/core-flows` package.
