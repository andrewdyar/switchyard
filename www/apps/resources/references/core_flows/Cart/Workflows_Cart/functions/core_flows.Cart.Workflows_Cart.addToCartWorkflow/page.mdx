...
# addToCartWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `addToCartWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow adds a product variant to a cart as a line item. It's executed by the
[Add Line Item Store API Route](https://docs.switchyard.com/api/store#carts\_postcartsidlineitems).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/cart/workflows/add-to-cart.ts#L114" />
