...
# completeCartWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `completeCartWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow completes a cart and places an order for the customer. It's executed by the
[Complete Cart Store API Route](https://docs.switchyard.com/api/store#carts\_postcartsidcomplete).
...
For example, in the [Subscriptions recipe](https://docs.switchyard.com/resources/recipes/subscriptions/examples/standard#create-workflow),
...
[entry point of the link](https://docs.switchyard.com/learn/fundamentals/module-links/custom-columns#method-2-using-entry-point)
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/cart/workflows/complete-cart.ts#L301" />
