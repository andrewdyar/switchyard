...
# updateLineItemInCartWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateLineItemInCartWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.
...
This workflow is executed by the [Update Line Item Store API Route](https://docs.switchyard.com/api/store#carts\_postcartsidlineitemsline\_id).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/cart/workflows/update-line-item-in-cart.ts#L111" />
...
import { updateLineItemInCartWorkflow } from "@switchyard/medusa/core-flows"
