...
# updateCartWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateCartWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.
...
[Update Cart Store API Route](https://docs.switchyard.com/api/store#carts\_postcartsid).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/cart/workflows/update-cart.ts#L82" />
...
import { updateCartWorkflow } from "@switchyard/medusa/core-flows"
