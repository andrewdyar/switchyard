...
# deleteCartCreditLinesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteCartCreditLinesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more credit lines from a cart.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/cart/workflows/delete-cart-credit-lines.ts#L13" />
...
import { deleteCartCreditLinesWorkflow } from "@switchyard/medusa/core-flows"
...
<TypeList types={[{"name":"id","type":"`string`[]","description":"The IDs of the credit lines to delete.","optional":false,"defaultValue":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="deleteCartCreditLinesWorkflow"/>
