...
# getPromotionCodesToApply - Switchyard Core Workflows Reference

This documentation provides a reference to the `getPromotionCodesToApply`. It belongs to the `@switchyard/medusa/core-flows` package.
