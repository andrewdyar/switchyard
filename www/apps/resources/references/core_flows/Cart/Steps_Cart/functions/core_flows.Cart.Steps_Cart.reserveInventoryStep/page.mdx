...
# reserveInventoryStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `reserveInventoryStep`. It belongs to the `@switchyard/medusa/core-flows` package.
