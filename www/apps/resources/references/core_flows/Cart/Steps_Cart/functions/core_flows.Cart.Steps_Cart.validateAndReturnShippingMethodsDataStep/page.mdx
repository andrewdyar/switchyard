...
# validateAndReturnShippingMethodsDataStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `validateAndReturnShippingMethodsDataStep`. It belongs to the `@switchyard/medusa/core-flows` package.
