...
# createShippingMethodAdjustmentsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createShippingMethodAdjustmentsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
