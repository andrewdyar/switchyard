...
# findSalesChannelStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `findSalesChannelStep`. It belongs to the `@switchyard/medusa/core-flows` package.
...
import { findSalesChannelStep } from "@switchyard/medusa/core-flows"
