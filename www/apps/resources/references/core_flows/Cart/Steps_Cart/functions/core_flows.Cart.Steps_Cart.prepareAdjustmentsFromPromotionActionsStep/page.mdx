...
# prepareAdjustmentsFromPromotionActionsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `prepareAdjustmentsFromPromotionActionsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
