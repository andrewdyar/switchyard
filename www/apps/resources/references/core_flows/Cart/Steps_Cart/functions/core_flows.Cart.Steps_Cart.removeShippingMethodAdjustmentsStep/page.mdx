...
# removeShippingMethodAdjustmentsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `removeShippingMethodAdjustmentsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
...
import { removeShippingMethodAdjustmentsStep } from "@switchyard/medusa/core-flows"
