...
# acquireLockStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `acquireLockStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step acquires a lock for a given key. Learn more about locks in the [Locking Module](https://docs.switchyard.com/resources/infrastructure-modules/locking)
guide.
