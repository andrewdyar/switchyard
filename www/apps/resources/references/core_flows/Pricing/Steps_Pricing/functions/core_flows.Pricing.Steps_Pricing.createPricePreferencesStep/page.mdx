...
# createPricePreferencesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createPricePreferencesStep`. It belongs to the `@switchyard/medusa/core-flows` package.
