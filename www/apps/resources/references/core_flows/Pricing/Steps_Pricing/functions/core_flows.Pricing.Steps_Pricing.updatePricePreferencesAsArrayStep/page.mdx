...
# updatePricePreferencesAsArrayStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `updatePricePreferencesAsArrayStep`. It belongs to the `@switchyard/medusa/core-flows` package.
