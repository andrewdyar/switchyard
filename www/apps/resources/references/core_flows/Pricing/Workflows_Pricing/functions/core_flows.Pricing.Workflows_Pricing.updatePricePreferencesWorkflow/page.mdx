...
# updatePricePreferencesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updatePricePreferencesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates one or more price preferences. It's used by the
[Update Price Preference Admin API Route](https://docs.switchyard.com/api/admin#price-preferences\_postpricepreferencesid).

You can use this workflow within your customizations or your own custom workflows, allowing you to
update price preferences in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/pricing/workflows/update-price-preferences.ts#L34" />
...
import { updatePricePreferencesWorkflow } from "@switchyard/medusa/core-flows"
