...
# createInviteStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createInviteStep`. It belongs to the `@switchyard/medusa/core-flows` package.
