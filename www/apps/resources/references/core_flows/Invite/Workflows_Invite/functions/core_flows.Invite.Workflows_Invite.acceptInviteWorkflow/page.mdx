...
# acceptInviteWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `acceptInviteWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow accepts an invite and creates a user. It's used by the
[Accept Invite Admin API Route](https://docs.switchyard.com/api/admin#invites\_postinvitesaccept).
...
using the [Retrieve Registration JWT Token API Route](https://docs.switchyard.com/api/admin#auth\_postactor\_typeauth\_provider\_register).

You can use this workflow within your customizations or your own custom workflows, allowing you to
accept invites within your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/invite/workflows/accept-invite.ts#L46" />
...
import { acceptInviteWorkflow } from "@switchyard/medusa/core-flows"
