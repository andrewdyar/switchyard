...
# createStoresStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createStoresStep`. It belongs to the `@switchyard/medusa/core-flows` package.
