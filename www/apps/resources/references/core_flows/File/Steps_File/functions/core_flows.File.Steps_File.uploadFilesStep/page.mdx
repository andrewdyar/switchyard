...
# uploadFilesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `uploadFilesStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step uploads one or more files using the installed
[File Module Provider](https://docs.switchyard.com/resources/infrastructure-modules/file).
