...
# createStockLocationsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createStockLocationsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more stock locations. It's used by the
[Create Stock Location Admin API Route](https://docs.switchyard.com/api/admin#stock-locations\_poststocklocations).

You can use this workflow within your own customizations or custom workflows, allowing you
to create stock locations in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/stock-location/workflows/create-stock-locations.ts#L45" />
...
import { createStockLocationsWorkflow } from "@switchyard/medusa/core-flows"
