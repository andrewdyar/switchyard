...
# createRegionsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createRegionsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more regions. It's used by the
[Create Region Admin API Route](https://docs.switchyard.com/api/admin#regions\_postregions).

You can use this workflow within your own customizations or custom workflows, allowing you
to create regions in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/region/workflows/create-regions.ts#L41" />
...
import { createRegionsWorkflow } from "@switchyard/medusa/core-flows"
