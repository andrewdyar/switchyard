...
# updateRegionsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateRegionsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates regions matching the specified filters. It's used by the
[Update Region Admin API Route](https://docs.switchyard.com/api/admin#regions\_postregionsid).

You can use this workflow within your own customizations or custom workflows, allowing you
to update regions in your custom flows.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/region/workflows/update-regions.ts#L41" />
...
import { updateRegionsWorkflow } from "@switchyard/medusa/core-flows"
