...
# updateOrderEditShippingMethodValidationStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateOrderEditShippingMethodValidationStep`. It belongs to the `@switchyard/medusa/core-flows` package.
...
You can retrieve an order change details using [Query](https://docs.switchyard.com/learn/fundamentals/module-links/query),
