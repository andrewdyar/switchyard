...
# createOrderPaymentCollectionWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createOrderPaymentCollectionWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates a payment collection for an order. It's used by the
[Create Payment Collection Admin API Route](https://docs.switchyard.com/api/admin#payment-collections\_postpaymentcollections).

You can use this workflow within your customizations or your own custom workflows, allowing you to wrap custom logic around
creating a payment collection for an order.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/create-order-payment-collection.ts#L47" />
...
import { createOrderPaymentCollectionWorkflow } from "@switchyard/medusa/core-flows"
