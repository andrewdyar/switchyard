...
# createOrderFulfillmentWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createOrderFulfillmentWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates a fulfillment for an order. It's used by the [Create Order Fulfillment Admin API Route](https://docs.switchyard.com/api/admin#orders\_postordersidfulfillments).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/create-fulfillment.ts#L394" />
...
import { createOrderFulfillmentWorkflow } from "@switchyard/medusa/core-flows"
