...
# getOrdersListWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `getOrdersListWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow retrieves a list of orders. It's used by the
[List Orders Admin API Route](https://docs.switchyard.com/api/admin#orders\_getorders), and the
[List Orders Store API Route](https://docs.switchyard.com/api/store#orders\_getorders).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/get-orders-list.ts#L114" />
