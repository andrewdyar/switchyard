...
# cancelOrderClaimWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `cancelOrderClaimWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow cancels a confirmed order claim. It's used by the
[Cancel Claim API Route](https://docs.switchyard.com/api/admin#claims\_postclaimsidcancel).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/claim/cancel-claim.ts#L111" />
...
import { cancelOrderClaimWorkflow } from "@switchyard/medusa/core-flows"
