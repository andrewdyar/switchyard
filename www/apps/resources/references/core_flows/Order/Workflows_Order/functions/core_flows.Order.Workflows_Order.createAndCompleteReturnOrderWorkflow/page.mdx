...
# createAndCompleteReturnOrderWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createAndCompleteReturnOrderWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.
...
[Create Return Store API Route](https://docs.switchyard.com/api/store#return\_postreturn).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/return/create-complete-return.ts#L350" />
