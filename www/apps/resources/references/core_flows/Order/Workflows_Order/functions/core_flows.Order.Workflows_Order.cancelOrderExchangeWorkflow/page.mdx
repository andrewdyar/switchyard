...
# cancelOrderExchangeWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `cancelOrderExchangeWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow cancels a confirmed exchange. It's used by the
[Cancel Exchange Admin API Route](https://docs.switchyard.com/api/admin#exchanges\_postexchangesidcancel).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/exchange/cancel-exchange.ts#L111" />
...
import { cancelOrderExchangeWorkflow } from "@switchyard/medusa/core-flows"
