...
# computeAdjustmentsForPreviewWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `computeAdjustmentsForPreviewWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/compute-adjustments-for-preview.ts#L77" />
...
import { computeAdjustmentsForPreviewWorkflow } from "@switchyard/medusa/core-flows"
