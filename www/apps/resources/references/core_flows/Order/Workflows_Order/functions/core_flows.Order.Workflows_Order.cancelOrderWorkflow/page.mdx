...
# cancelOrderWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `cancelOrderWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.
...
This workflow is used by the [Cancel Order Admin API Route](https://docs.switchyard.com/api/admin#orders\_postordersidcancel).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/cancel-order.ts#L125" />
