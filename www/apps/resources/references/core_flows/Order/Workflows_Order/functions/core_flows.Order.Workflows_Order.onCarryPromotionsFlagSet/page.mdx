...
# onCarryPromotionsFlagSet - Switchyard Core Workflows Reference

This documentation provides a reference to the `onCarryPromotionsFlagSet`. It belongs to the `@switchyard/medusa/core-flows` package.
...
This is available starting from [Switchyard v2.12.0](https://github.com/switchyard/medusa/releases/tag/v2.12.0).

:::

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/on-carry-promotions-flag-set.ts#L168" />
...
import { onCarryPromotionsFlagSet } from "@switchyard/medusa/core-flows"
