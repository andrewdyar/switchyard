...
This is available starting from [Medusa vv2.12.0](https://github.com/medusajs/medusa/releases/tag/vv2.12.0).

:::

<SourceCodeLink link="https://github.com/medusajs/medusa/blob/e4513fab88f5ba7d5c078d3e251e04b104268a56/packages/core/core-flows/src/order/workflows/on-carry-promotions-flag-set.ts#L168" />
