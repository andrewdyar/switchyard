...
# validateOrderCreditLinesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `validateOrderCreditLinesStep`. It belongs to the `@switchyard/medusa/core-flows` package.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { validateOrderCreditLinesStep } from "@switchyard/medusa/core-flows"
...
const myWorkflow = createWorkflow(
  ...
  () => {
    const data = validateOrderCreditLinesStep({
      "order": {
        "id": "id_XtLaaryDNrkBoOT",
        "version": 35,
        "display_id": 30,
        "status": "requires_action",
        "currency_code": "hnl",
        "created_at": "2026-04-15T17:23:46.640Z",
        "updated_at": "2026-07-12T20:47:42.854Z",
        "original_item_total": {
          "numeric": 23
        },
