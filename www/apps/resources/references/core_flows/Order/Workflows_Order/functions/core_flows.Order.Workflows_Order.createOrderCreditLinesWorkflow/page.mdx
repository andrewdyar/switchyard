...
# createOrderCreditLinesWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createOrderCreditLinesWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/create-order-credit-lines.ts#L86" />
...
import { createOrderCreditLinesWorkflow } from "@switchyard/medusa/core-flows"
...
<TypeList types={[{"name":"input","type":"`object`","description":"The input data for the hook.","optional":false,"defaultValue":"","expandable":false,"children":[]}]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" openedLevel={1} sectionTitle="creditLinesCreated"/>
