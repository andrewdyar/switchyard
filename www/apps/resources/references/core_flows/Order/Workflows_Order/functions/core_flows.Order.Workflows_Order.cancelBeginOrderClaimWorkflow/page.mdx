...
# cancelBeginOrderClaimWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `cancelBeginOrderClaimWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow cancels a requested order claim. It's used by the
[Cancel Claim Request Admin API Route](https://docs.switchyard.com/api/admin#claims\_deleteclaimsidrequest).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/order/workflows/claim/cancel-begin-order-claim.ts#L114" />
...
import { cancelBeginOrderClaimWorkflow } from "@switchyard/medusa/core-flows"
