...
# addOrderTransactionStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `addOrderTransactionStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step creates order transactions.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { addOrderTransactionStep } from "@switchyard/medusa/core-flows"
