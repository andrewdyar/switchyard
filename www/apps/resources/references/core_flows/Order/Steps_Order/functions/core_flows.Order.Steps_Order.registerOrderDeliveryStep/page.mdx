...
# registerOrderDeliveryStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `registerOrderDeliveryStep`. It belongs to the `@switchyard/medusa/core-flows` package.
...
import { registerOrderDeliveryStep } from "@switchyard/medusa/core-flows"
