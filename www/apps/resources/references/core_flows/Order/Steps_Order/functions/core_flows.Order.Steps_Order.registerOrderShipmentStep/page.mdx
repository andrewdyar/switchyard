...
# registerOrderShipmentStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `registerOrderShipmentStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step registers a shipment for an order.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { registerOrderShipmentStep } from "@switchyard/medusa/core-flows"
