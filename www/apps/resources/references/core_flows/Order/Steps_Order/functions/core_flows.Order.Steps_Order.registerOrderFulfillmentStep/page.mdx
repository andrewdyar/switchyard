...
# registerOrderFulfillmentStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `registerOrderFulfillmentStep`. It belongs to the `@switchyard/medusa/core-flows` package.
