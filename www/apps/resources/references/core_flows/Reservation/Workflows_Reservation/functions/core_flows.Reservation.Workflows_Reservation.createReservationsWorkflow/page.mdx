...
# createReservationsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createReservationsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more reservations. It's used by the
[Create Reservations Admin API Route](https://docs.switchyard.com/api/admin#reservations\_postreservations).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/reservation/workflows/create-reservations.ts#L36" />
...
import { createReservationsWorkflow } from "@switchyard/medusa/core-flows"
