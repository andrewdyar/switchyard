...
# createReservationsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createReservationsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
