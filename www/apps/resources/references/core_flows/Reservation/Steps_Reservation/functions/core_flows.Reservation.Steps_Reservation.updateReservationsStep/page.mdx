...
# updateReservationsStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateReservationsStep`. It belongs to the `@switchyard/medusa/core-flows` package.
