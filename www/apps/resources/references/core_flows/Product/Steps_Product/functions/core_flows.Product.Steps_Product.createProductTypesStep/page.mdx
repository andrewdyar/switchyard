...
# createProductTypesStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `createProductTypesStep`. It belongs to the `@switchyard/medusa/core-flows` package.

This step creates one or more product types.

```ts title="src/workflows/my-workflow.ts"
import { createWorkflow } from "@switchyard/framework/workflows-sdk"
import { createProductTypesStep } from "@switchyard/medusa/core-flows"
