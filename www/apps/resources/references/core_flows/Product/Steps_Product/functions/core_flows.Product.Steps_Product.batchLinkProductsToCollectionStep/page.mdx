...
# batchLinkProductsToCollectionStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `batchLinkProductsToCollectionStep`. It belongs to the `@switchyard/medusa/core-flows` package.
