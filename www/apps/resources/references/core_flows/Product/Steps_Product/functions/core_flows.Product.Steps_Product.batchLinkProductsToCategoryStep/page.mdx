...
# batchLinkProductsToCategoryStep - Switchyard Core Workflows Reference

This documentation provides a reference to the `batchLinkProductsToCategoryStep`. It belongs to the `@switchyard/medusa/core-flows` package.
