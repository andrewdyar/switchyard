...
# importProductsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `importProductsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow starts a product import from a CSV file in the background. It's used by the
[Import Products Admin API Route](https://docs.switchyard.com/api/admin#products\_postproductsimport).
...
The workflow only starts the import, but you'll have to confirm it using the [Workflow Engine](https://docs.switchyard.com/resources/infrastructure-modules/workflow-engine).
The below example shows how to confirm the import.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product/workflows/import-products.ts#L88" />
...
import { importProductsWorkflow } from "@switchyard/medusa/core-flows"
...
You confirm the import using the [Workflow Engine](https://docs.switchyard.com/resources/infrastructure-modules/workflow-engine).
