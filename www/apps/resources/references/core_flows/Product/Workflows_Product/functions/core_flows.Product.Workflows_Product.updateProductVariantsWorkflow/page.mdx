...
# updateProductVariantsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateProductVariantsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates one or more product variants. It's used by the [Update Product Variant Admin API Route](https://docs.switchyard.com/api/admin#products\_postproductsidvariantsvariant\_id).
...
[Price Rules](https://docs.switchyard.com/resources/commerce-modules/pricing/price-rules) documentation.

:::

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product/workflows/update-product-variants.ts#L127" />
...
import { updateProductVariantsWorkflow } from "@switchyard/medusa/core-flows"
