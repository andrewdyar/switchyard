...
# updateCollectionsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `updateCollectionsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow updates one or more collections. It's used by the
[Create Collection Admin API Route](https://docs.switchyard.com/api/admin#collections\_postcollectionsid).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product/workflows/update-collections.ts#L59" />
...
import { updateCollectionsWorkflow } from "@switchyard/medusa/core-flows"
