...
# deleteProductOptionsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `deleteProductOptionsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow deletes one or more product options. It's used by the
[Delete Product Option Admin API Route](https://docs.switchyard.com/api/admin#products\_deleteproductsidoptionsoption\_id).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product/workflows/delete-product-options.ts#L48" />
...
import { deleteProductOptionsWorkflow } from "@switchyard/medusa/core-flows"
