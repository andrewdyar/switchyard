...
# createProductVariantsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `createProductVariantsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates one or more product variants. It's used by the [Create Product Variant Admin API Route](https://docs.switchyard.com/api/admin#products\_postproductsidvariants).
...
<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product/workflows/create-product-variants.ts#L249" />
...
import { createProductVariantsWorkflow } from "@switchyard/medusa/core-flows"
