...
# batchProductVariantsWorkflow - Switchyard Core Workflows Reference

This documentation provides a reference to the `batchProductVariantsWorkflow`. It belongs to the `@switchyard/medusa/core-flows` package.

This workflow creates, updates, and deletes product variants. It's used by the 
[Manage Variants in a Product Admin API Route](https://docs.switchyard.com/api/admin#products\_postproductsidvariantsbatch).
...
use this within a [seed script](https://docs.switchyard.com/learn/fundamentals/custom-cli-scripts/seed-data) or in a custom import script.

<SourceCodeLink link="https://github.com/switchyard/medusa/blob/da5d0e3a1430979ab9cda7f239ea7066ded1f7ab/packages/core/core-flows/src/product/workflows/batch-product-variants.ts#L73" />
...
import { batchProductVariantsWorkflow } from "@switchyard/medusa/core-flows"
