...
slug: /references/payment/deleteRefunds
sidebar_label: deleteRefunds
---
...
This documentation provides a reference to the `deleteRefunds` method. This belongs to the Payment Module.
