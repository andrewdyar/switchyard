...
slug: /references/payment/deleteCaptures
sidebar_label: deleteCaptures
---

import { TypeList } from "docs-ui"

# deleteCaptures - Payment Module Reference

This documentation provides a reference to the `deleteCaptures` method. This belongs to the Payment Module.
