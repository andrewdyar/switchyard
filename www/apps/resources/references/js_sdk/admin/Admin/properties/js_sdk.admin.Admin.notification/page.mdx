...
This documentation provides a reference to the `sdk.admin.notification` set of methods used to send requests to Switchyard's Admin API routes.

## retrieve

This method retrieves a notification's details. It sends a request to the 
[Get Notification](https://docs.switchyard.com/api/admin#notifications\_getnotificationsid)
API route.
...
[List Notifications](https://docs.switchyard.com/api/admin#notifications\_getnotifications)
API route.
