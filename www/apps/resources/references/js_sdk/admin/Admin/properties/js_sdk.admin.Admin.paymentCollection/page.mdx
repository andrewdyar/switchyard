...
This documentation provides a reference to the `sdk.admin.paymentCollection` set of methods used to send requests to Switchyard's Admin API routes.

## create

This method creates a payment collection. It sends a request to the
[Create Payment Collection](https://docs.switchyard.com/api/admin#payment-collections\_postpaymentcollections)
API route.
...
[Delete Payment Collection](https://docs.switchyard.com/api/admin#payment-collections\_deletepaymentcollectionsid)
API route.
...
[Mark as Paid](https://docs.switchyard.com/api/admin#payment-collections\_postpaymentcollectionsidmarkaspaid)
API route.
