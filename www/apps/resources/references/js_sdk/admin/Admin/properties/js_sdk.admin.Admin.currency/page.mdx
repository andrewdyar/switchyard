...
This documentation provides a reference to the `sdk.admin.currency` set of methods used to send requests to Switchyard's Admin API routes.

## list

This method retrieves a paginated list of currencies. It sends a request to the
[List Currencies](https://docs.switchyard.com/api/admin#currencies\_getcurrencies)
API route.
...
[Get Currency](https://docs.switchyard.com/api/admin#currencies\_getcurrenciescode) API route.
