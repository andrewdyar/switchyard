...
or remove associations. It sends a request to the [Manage Sales Channels](https://docs.switchyard.com/api/admin#api-keys\_postapikeysidsaleschannels)
API route.
