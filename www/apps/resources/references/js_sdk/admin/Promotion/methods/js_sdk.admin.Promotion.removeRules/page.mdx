...
[Manage Promotion's Rules API Route](https://docs.switchyard.com/api/admin#promotions\_postpromotionsidrulesbatch).
- If you set the `ruleType` to `buy-rules`, the method sends a request to the
[Manage Promotion's Buy Rules API Route](https://docs.switchyard.com/api/admin#promotions\_postpromotionsidbuyrulesbatch).
- If you set the `ruleType` to `target-rules`, the method sends a request to the
[Manage Promotion's Target Rules API Route](https://docs.switchyard.com/api/admin#promotions\_postpromotionsidtargetrulesbatch).
