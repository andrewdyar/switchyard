...
This documentation page includes the list of all events emitted by [Switchyard's workflows](https://docs.switchyard.com/resources/medusa-workflows-reference).
