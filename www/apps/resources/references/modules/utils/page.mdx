...
- [SwitchyardModuleProviderType](page.mdx#medusamoduleprovidertype)
- [SwitchyardModuleType](page.mdx#medusamoduletype)
...
### SwitchyardModuleProviderType
 ...
 `Const` **SwitchyardModuleProviderType**: typeof [SwitchyardModuleProviderType](page.mdx#medusamoduleprovidertype)

### SwitchyardModuleType

 `Const` **SwitchyardModuleType**: typeof [SwitchyardModuleType](page.mdx#medusamoduletype)
