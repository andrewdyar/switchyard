...
slug: /references/auth/deleteProviderIdentities
sidebar_label: deleteProviderIdentities
---
...
This documentation provides a reference to the `deleteProviderIdentities` method. This belongs to the Auth Module.
