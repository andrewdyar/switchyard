...
Learn more about this authentication flow in [this guide](https://docs.switchyard.com/resources/commerce-modules/auth/authentication-route#2-third-party-service-authenticate-flow).
