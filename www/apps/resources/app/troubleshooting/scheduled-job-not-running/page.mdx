...
This troubleshooting guide helps you troubleshoot issues when a scheduled job in your Switchyard application is not running, or running at unexpected times.

## Confirm Job is Set Up Correctly

Make sure that the scheduled job is set up correctly in your Switchyard application. Check the following:
