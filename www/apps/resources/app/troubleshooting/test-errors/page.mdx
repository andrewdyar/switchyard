...
This troubleshooting guide covers common errors you may encounter when running tests in your Switchyard application and how to resolve them.
...
If you're using a version prior to Switchyard v2.11.0, change `@switchyard/framework/mikro-orm/core` to `@mikro-orm/core`. Learn more in the [v2.11.0 codemod](!docs!/learn/codemods/replace-imports).
