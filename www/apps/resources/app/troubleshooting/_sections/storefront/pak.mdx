...
To resolve this error, add the `x-publishable-api-key` header to your request. You can find your publishable API key in the [Switchyard Admin Dashboard](!user-guide!/settings/developer/publishable-api-keys).
