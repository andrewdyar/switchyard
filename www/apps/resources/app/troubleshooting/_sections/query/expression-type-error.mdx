...
This issue has been resolved in [Switchyard v2.8.5+](https://github.com/switchyard/medusa/releases/tag/v2.8.5). If you're facing this error, please [update your Switchyard application](!docs!/learn/update) and run the `dev` command. If the issue persists, please [report it on GitHub](https://github.com/switchyard/medusa/issues/new/choose).
