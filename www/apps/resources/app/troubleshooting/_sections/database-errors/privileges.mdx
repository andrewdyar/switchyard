The database user you use in the `databaseUrl` Switchyard backend configuration must have create privileges. Otherwise, you'll face problems when running migrations.
