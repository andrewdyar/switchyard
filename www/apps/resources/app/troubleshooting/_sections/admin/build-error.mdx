If you get the following error when you start the Switchyard application, typically in production:
...
You can also follow the [General Deployment](!docs!/learn/deployment/general) documentation if you're facing this error in your deployed application. This guide gives you the general steps to follow when deploying your Switchyard application.
