...
This is a reference to the `medusaIntegrationTestRunner` function provided by the `@switchyard/test-utils` package.
  ...
  types={[
    {
      ...
      children: [
        {
          type: "`(options: SwitchyardSuiteOptions) => void`",
          name: "testSuite",
        ...
        },
        {
          ...
          description: "The path to the `switchyard.config.ts` file, excluding `switchyard.config.ts`. This path is used as the current working directory as well.",
        ...
        },
        {
          ...
          children: [
            {
              type: "`(container: SwitchyardContainer) => Promise<void>`",
              name: "beforeServerStart",
              description: "A hook that runs before the Switchyard server starts.",
          optional: true
            }
          ]
        }
      ...
      children: [
        {
          ...
          name: "api",
          description: "A set of methods used to send requests to the Switchyard application.",
          optional: false,
          children: [
            {
        ...
        {
          type: "`() => SwitchyardContainer`",
          name: "getContainer",
          description: "A function that returns the Switchyard container.",
        },
        {
