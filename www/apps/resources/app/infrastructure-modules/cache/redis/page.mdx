...
The Redis Cache Module is deprecated starting from [Switchyard v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0). Use the [Redis Caching Module Provider](../../caching/providers/redis/page.mdx) instead.
...
```ts title="switchyard.config.ts" highlights={highlights}
...
To test the module, start the Switchyard application:
