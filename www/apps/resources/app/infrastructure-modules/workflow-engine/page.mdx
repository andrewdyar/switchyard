...
In this document, you'll learn what a Workflow Engine Module is and how to use it in your Switchyard application.
...
Switchyard uses the [In-Memory Workflow Engine Module](./in-memory/page.mdx) by default. For production purposes, it's recommended to use the [Redis Workflow Engine Module](./redis/page.mdx) instead.
...
In the example above, you create a workflow that has a step. In the step, you resolve the service of the Workflow Engine Module from the [Switchyard container](!docs!/learn/fundamentals/medusa-container).
...
Switchyard provides the following Workflow Engine Modules.
