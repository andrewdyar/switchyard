...
In your workflow's step, you can resolve the Workflow Engine Module's service from the Switchyard container:
...
This method retries a step that has temporary failed, such as a step that has `autoRetry` set to `false` or when the machine running the Switchyard application shuts down. Learn more about it in the [Retry Failed Steps](!docs!/learn/fundamentals/workflows/retry-failed-steps) guide.

<Note>

This method is available since [Switchyard v2.10.2](https://github.com/switchyard/medusa/releases/tag/v2.10.2).
    ...
    "children": [
      {
        "name": "container",
        "type": "`Container`",
        "description": "An instance of the Switchyard container.",
        "optional": false,
        "defaultValue": "",
        "expandable": false,
        "children": []
...
]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="retryStep"/>
...
]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="setStepSuccess"/>
...
]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="setStepFailure"/>
...
]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="subscribe"/>
...
]} expandUrl="https://docs.switchyard.com/learn/fundamentals/data-models/manage-relationships#retrieve-records-of-relation" sectionTitle="unsubscribe"/>