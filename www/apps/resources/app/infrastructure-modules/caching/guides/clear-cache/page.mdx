...
In this guide, you'll learn how to clear cached data in Switchyard.
...
For example, if you've integrated a third-party system that updates product information outside of Switchyard, or if you've cached data from the third-party system, Switchyard won't be aware of changes made externally.

In such cases, you should clear the cache in Switchyard to ensure it fetches the most up-to-date information from the source rather than relying on outdated cached data.

---

## How to Clear Cache

This section explains how to clear data cached by the Caching Module in Switchyard.
