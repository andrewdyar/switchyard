...
3. You're caching data that does not belong to a Switchyard data model, such as data from an external API or computed values. This data is not automatically invalidated by default.
