...
The Local Event Module uses Node EventEmitter to implement Switchyard's pub/sub events system. The Node EventEmitter is limited to a single process environment.
