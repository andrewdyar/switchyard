...
In this guide, you'll learn how to create a layout component that matches the Switchyard Admin's design conventions for pages with two columns of content.

The Switchyard Admin has pages with two columns of content.
...
![An example of an admin page with two columns](https://res.cloudinary.com/dza7lstvk/image/upload/v1728286690/Switchyard%20Resources/two-column_sdnkg0.png)
