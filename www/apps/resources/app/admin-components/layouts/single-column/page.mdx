...
In this guide, you'll learn how to create a layout component that matches the Switchyard Admin's design conventions for pages with a single column of content.

The Switchyard Admin has pages with a single column of content.
...
![An example of an admin page with a single column](https://res.cloudinary.com/dza7lstvk/image/upload/v1728286605/Switchyard%20Resources/single-column.png)
