...
In this guide, you'll learn how to create forms that match the Switchyard Admin's design conventions.

The Switchyard Admin has two types of forms:
...
This guide explains how to create these two form types following the Switchyard Admin's conventions.

## Form Tooling

The Switchyard Admin uses the following tools to build the forms:
...
You can replace the content of the function with sending a request to Switchyard's routes. Refer to [this guide](!docs!/learn/fundamentals/admin/tips#send-requests-to-api-routes) for more details on how to do that.
