...
In this guide, you'll learn how to create a header component that matches the Switchyard Admin's design conventions.

Each section in the Switchyard Admin has a header with a title, and optionally a subtitle with buttons to perform an action.

![Example of a header in a section](https://res.cloudinary.com/dza7lstvk/image/upload/v1728288562/Switchyard%20Resources/header_dtz4gl.png)
...
import { Heading, Button, Text } from "@switchyard/ui"
