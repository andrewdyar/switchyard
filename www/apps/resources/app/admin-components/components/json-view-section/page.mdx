...
In this guide, you'll learn how to create a JSON view section that matches the Switchyard Admin's design conventions.

Detail pages in the Switchyard Admin show a JSON section to view the current page's details in JSON format.

![Example of a JSON section in the admin](https://res.cloudinary.com/dza7lstvk/image/upload/v1728295129/Switchyard%20Resources/json_dtbsgm.png)
