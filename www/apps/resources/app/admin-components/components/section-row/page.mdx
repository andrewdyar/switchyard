...
In this guide, you'll learn how to create a section row component that matches the Switchyard Admin's design conventions.

The Switchyard Admin often shows information in rows of label-values, such as when showing a product's details.

![Example of a section row in the Switchyard Admin](https://res.cloudinary.com/dza7lstvk/image/upload/v1728292781/Switchyard%20Resources/section-row_kknbnw.png)
