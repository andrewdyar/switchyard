...
export const metadata = {
  title: `new Command - Switchyard CLI Reference`,
}

# {metadata.title}

Create a new Switchyard application. Unlike the `create-switchyard-app` CLI tool, this command provides more flexibility for experienced Switchyard developers in creating and configuring their project.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      The name of the directory to create the Switchyard application in.
