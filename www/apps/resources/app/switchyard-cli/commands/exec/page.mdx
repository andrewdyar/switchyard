...
export const metadata = {
  title: `exec Command - Switchyard CLI Reference`,
}

# {metadata.title}

Run a custom CLI script using Switchyard's CLI tool. Learn more about it in [Custom CLI Scripts guide](!docs!/learn/fundamentals/custom-cli-scripts).

```bash
npx switchyard exec [file] [args...]
```
