...
import PortForwardingTroubleshooting from "../troubleshooting/_sections/create-switchyard-app-errors/forwarding.mdx"
import DBUrlTroubleshooting from "../troubleshooting/_sections/create-switchyard-app-errors/db-url-error.mdx"
...
import EagainTroubleshooting from "../troubleshooting/_sections/create-switchyard-app-errors/eagain-error.mdx"
import TypeErrorTroubleshooting from "../troubleshooting/_sections/create-switchyard-app-errors/typeerror.mdx"
import ConnectionErrorTroubleshooting from "../troubleshooting/_sections/database-errors/connection-error.mdx"
import NoBrowserTroubleshooting from "../troubleshooting/_sections/create-switchyard-app-errors/no-browser-token-error.mdx"
import OtherErrorsTroubleshooting from "../troubleshooting/_sections/create-switchyard-app-errors/other-errors.mdx"

export const metadata = {
  title: `create-switchyard-app CLI Tool`,
}

# {metadata.title}

The `create-switchyard-app` CLI tool simplifies the process of creating a new Switchyard project. It also allows you to setup a [Switchyard plugin project](#create-a-medusa-plugin-project).
...
```bash
npx create-switchyard-app@latest [project-name]
```
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      `https://github.com/switchyard/medusa-starter-default`
    ...
    <Table.Row>
      ...
      <Table.Cell>
        ...
        Create a [plugin project](#create-a-medusa-plugin-project) instead of a Switchyard application. This option is available starting from [Switchyard v2.3.0](https://github.com/switchyard/medusa/releases/tag/v2.3.0).
    ...
    <Table.Row>
      ...
      <Table.Cell>
        ...
        Specify the Switchyard version to install in the project. The specified version will be used for every `@switchyard/*` package in the Switchyard and Next.js Starter projects.

      </Table.Cell>
      <Table.Cell>
      
        The latest version of Switchyard at the time of running the command.
...
```bash
npx create-switchyard-app@latest --db-url "postgres://default:<password><host-region>.postgres.vercel-storage.com:5432/verceldb?sslmode=require"
```
...
```bash
npx create-switchyard-app@latest --db-url "postgres://postgres.<host>:<password>@aws-0-eu-central-1.pooler.supabase.com:5432/postgres"
```
...
## Create a Switchyard Plugin Project

The `create-switchyard-app` tool can also be used to create a Switchyard Plugin Project. You can do that by passing the `--plugin` option:

```bash
npx create-switchyard-app@latest my-plugin --plugin
```
...
## Install a Specific Switchyard Version

To install a specific version of Switchyard, use the `--version` option. This will install the specified version for every `@switchyard/*` package in the Switchyard and Next.js Starter projects. For example:

```bash
npx create-switchyard-app@latest my-medusa-store --version 2.3.0
```

This will create a new Switchyard project with the `2.3.0` version.
