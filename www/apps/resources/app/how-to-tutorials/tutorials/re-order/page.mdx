...
export const metadata = {
  title: `Implement Quick Re-Order Functionality in Switchyard`,
  openGraph: {
    images: [
      {
        url: ogImage,
...
In this tutorial, you'll learn how to implement a re-order functionality in Switchyard.

When you install a Switchyard application, you get a fully-fledged commerce platform with a Framework for customization. The Switchyard application's commerce features are built around [Commerce Modules](../../../commerce-modules/page.mdx) which are available out-of-the-box. The features include order-management features.

The Switchyard Framework facilitates building custom features that are necessary for your business use case. In this tutorial, you'll learn how to implement a re-order functionality in Switchyard. This feature is useful for businesses whose customers are likely to repeat their orders, such as B2B or food delivery businesses.
...
![Diagram showcasing the re-order logic](https://res.cloudinary.com/dza7lstvk/image/upload/v1746451309/Switchyard%20Resources/reorder-summary_wnbbws.jpg)

<CardList items={[
  {
    href: "https://github.com/switchyard/examples/tree/main/re-order",
...
To build custom commerce features in Switchyard, you create a [workflow](!docs!/learn/fundamentals/workflows). A workflow is a series of queries and actions, called steps, that complete a task.
...
This workflow uses steps from Switchyard's `@switchyard/medusa/core-flows` package. So, you can implement the workflow without implementing custom steps.
...
Data manipulation is not allowed in a workflow, as Switchyard stores its definition before executing it. Instead, you can use `transform` from the Workflows SDK to manipulate the data.
...
- Invoke it, passing it the [Switchyard container](!docs!/learn/fundamentals/medusa-container) available in the `req.scope` property.
    - The Switchyard container is a registry of Framework and commerce resources that you can resolve and use in your customizations.
...
So, if your Switchyard application's directory is `medusa-reorder`, you can find the storefront by going back to the parent directory and changing to the `medusa-reorder-storefront` directory:
...
First, to start the Switchyard application, run the following command in the Switchyard application's directory:
...
![Orders page on customer account](https://res.cloudinary.com/dza7lstvk/image/upload/v1746449666/Switchyard%20Resources/Screenshot_2025-05-05_at_3.52.46_PM_ae4e78.png)

On the order's details page, you'll find a "Reorder" button.

![Reorder button on order details page](https://res.cloudinary.com/dza7lstvk/image/upload/v1746450255/Switchyard%20Resources/Screenshot_2025-05-05_at_4.03.51_PM_xaslqo.png)
...
![Checkout page showing the payment step](https://res.cloudinary.com/dza7lstvk/image/upload/v1746450342/Switchyard%20Resources/Screenshot_2025-05-05_at_4.05.29_PM_vqpdqo.png)

---

## Next Steps

You now have a re-order functionality in your Switchyard application and Next.js Starter Storefront. You can expand more on this feature based on your use case.
