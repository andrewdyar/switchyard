...
In this section of the documentation, you'll find guides and references related to Switchyard's Commerce Modules.

A Commerce Module provides features for a commerce domain within its service. The Switchyard application exposes these features in its API routes to clients.

A Commerce Module also defines data models, representing tables in the database. The Switchyard Framework and tools allow you to extend these data models to add custom fields.
...
- Switchyard Application: The Switchyard application uses the Commerce Modules to expose commerce features through the REST APIs.
