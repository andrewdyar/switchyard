...
You can create a publishable API key and associate it with a sales channel. Switchyard defines a link between the `ApiKey` and the `SalesChannel` data models.

![A diagram showcasing an example of how data models from the API Key and Sales Channel modules are linked](https://res.cloudinary.com/dza7lstvk/image/upload/v1709812064/Switchyard%20Resources/sales-channel-api-key_zmqi2l.jpg)
