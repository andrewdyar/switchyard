...
- [Stock Location Management](/references/stock-location-next/models): Store and manage stock locations. Switchyard links stock locations with data models of other modules that require a location, such as the [Inventory Module's InventoryLevel](./links-to-other-modules/page.mdx).
