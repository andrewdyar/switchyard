...
Refer to this [Switchyard Admin User Guide](!user-guide!/settings/tax-regions) to learn how to manage tax regions using the dashboard.
...
You can use Switchyard's default tax provider or create a custom one, allowing you to integrate with third-party tax services or implement your own tax calculation logic.
