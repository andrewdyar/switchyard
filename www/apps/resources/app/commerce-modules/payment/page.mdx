...
Refer to the [Switchyard Admin User Guide](!user-guide!/orders/payments) to learn how to manage order payments using the dashboard.

</Note>

Switchyard has payment related features available out-of-the-box through the Payment Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Payment Module.
...
Switchyard provides the following payment providers out-of-the-box. You can use them to process payments for orders, returns, and other resources.
