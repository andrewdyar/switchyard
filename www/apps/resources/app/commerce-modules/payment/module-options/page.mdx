...
The `providers` option is an array of payment module providers to be registered in your Switchyard application.

When the Switchyard application starts, these providers are registered and can be used to process payments.
