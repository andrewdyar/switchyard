...
Refer to the [Switchyard Admin User Guide](!user-guide!/settings/store) to learn how to manage your store's currencies using the dashboard.

</Note>

Switchyard has currency related features available out-of-the-box through the Currency Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Currency Module.
