...
In this document, you’ll learn how registered and unregistered accounts are distinguished in the Switchyard application.

<Note title="Looking for no-code docs?">

Refer to this [Switchyard Admin User Guide](!user-guide!/customers) to learn how to manage customers using the dashboard.
...
When using the Switchyard Application with the [Auth Module](../../auth/page.mdx), possible confusion may arise in the following scenarios:
...
- [Conceptual guide on how to implement this flow with Switchyard's authentication routes](../../auth/authentication-route/page.mdx#handling-existing-identities).
