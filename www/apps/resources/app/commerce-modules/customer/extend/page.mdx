...
- Set the `custom_name` property when a customer is created or updated using Switchyard's API routes.
...
import { updateCustomersWorkflow } from "@switchyard/medusa/core-flows"
import { 
