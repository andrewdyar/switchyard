...
Refer to the [Switchyard Admin User Guide](!user-guide!/settings/regions) to learn how to manage regions using the dashboard.

</Note>

Switchyard has region related features available out-of-the-box through the Region Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Region Module.
