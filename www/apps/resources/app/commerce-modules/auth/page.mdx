...
Switchyard has auth related features available out-of-the-box through the Auth Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Auth Module.
...
import { Modules, SwitchyardError } from "@switchyard/framework/utils"
import { SwitchyardRequest } from "@switchyard/framework/http"
import { AuthenticationInput } from "@switchyard/framework/types"
...
Switchyard provides the following authentication providers out-of-the-box. You can use them to authenticate admin users, customers, or custom actor types.
