...
Refer to the [Switchyard Admin User Guide](!user-guide!/price-lists) to learn how to manage price lists using the dashboard.

</Note>

Switchyard has pricing related features available out-of-the-box through the Pricing Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Pricing Module.
...
- [Tax-Inclusive Pricing](./tax-inclusive-pricing/page.mdx): Calculate prices with taxes included in the price, and Switchyard will handle calculating the taxes automatically.
