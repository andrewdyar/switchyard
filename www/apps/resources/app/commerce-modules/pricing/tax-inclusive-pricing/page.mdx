...
A tax-inclusive price is a price of a resource that includes taxes. Switchyard calculates the tax amount from the price rather than adds the amount to it.
