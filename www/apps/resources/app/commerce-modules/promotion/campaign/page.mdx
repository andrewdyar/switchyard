...
Refer to this [Switchyard Admin User Guide](!user-guide!/promotions/campaigns) to learn how to manage campaigns using the dashboard.
...
![A diagram showcasing the relation between the Campaign and Promotion data models](https://res.cloudinary.com/dza7lstvk/image/upload/v1709899225/Switchyard%20Resources/campagin-promotion_hh3qsi.jpg)
...
![A diagram showcasing the relation between the Campaign and CampaignBudget data models](https://res.cloudinary.com/dza7lstvk/image/upload/v1709899463/Switchyard%20Resources/campagin-budget_rvqlmi.jpg)
...
Attribute-based budgets were introduced in [Switchyard v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0).
...
![A diagram showcasing the relation between the CampaignBudget and CampaignBudgetUsage data models](https://res.cloudinary.com/dza7lstvk/image/upload/v1760340527/Switchyard%20Resources/campaign-budget-attr_fv0v2u.jpg)

---

## How Campaign Budgets Limit Promotion Usage

When a customer tries to use a promotion, Switchyard checks whether the campaign has a budget and if the budget limit has been reached. If the limit is reached, the promotion cannot be applied.
