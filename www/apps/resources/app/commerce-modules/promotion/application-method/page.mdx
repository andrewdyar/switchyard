...
![A diagram showcasing the target_rules relation between the ApplicationMethod and PromotionRule data models](https://res.cloudinary.com/dza7lstvk/image/upload/v1709898273/Switchyard%20Resources/application-method-target-rules_hqaymz.jpg)
...
![A diagram showcasing the buy_rules relation between the ApplicationMethod and PromotionRule data models](https://res.cloudinary.com/dza7lstvk/image/upload/v1709898453/Switchyard%20Resources/application-method-buy-rules_djjuhw.jpg)
...
The `once` allocation type is available from [Switchyard v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0).
