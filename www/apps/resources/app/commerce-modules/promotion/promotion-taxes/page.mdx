...
This feature is available from [Switchyard v2.8.5](https://github.com/switchyard/medusa/releases/tag/v2.8.5).
...
In this scenario, Switchyard applies taxes consistently across the cart, ensuring that the total price reflects the taxes and promotions correctly.
...
You can enable tax-inclusiveness for a promotion when [creating it in the Switchyard Admin](!user-guide!/promotions/create).
