...
The Switchyard application infers the associated sales channels and ensures that only data relevant to the sales channel are used.

---

## How to Create a Publishable API Key?

To create a publishable API key, either use the [Switchyard Admin](!user-guide!/settings/developer/publishable-api-keys) or the [Admin API Routes](!api!/admin#publishable-api-keys).
