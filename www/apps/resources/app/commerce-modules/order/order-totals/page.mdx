...
In this guide, you'll learn how to retrieve order totals in your Switchyard application using [Query](!docs!/learn/fundamentals/module-links/query).

You may need to retrieve order totals in your Switchyard customizations, such as workflows or custom API routes, to perform custom actions with them. The ideal way to retrieve totals is using Query.
