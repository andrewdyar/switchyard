...
![A diagram showcasing the relation between an order and its items.](https://res.cloudinary.com/dza7lstvk/image/upload/v1712304722/Switchyard%20Resources/order-order-items_uvckxd.jpg)
...
![A diagram showcasing the relation between an order and its items.](https://res.cloudinary.com/dza7lstvk/image/upload/v1719570409/Switchyard%20Resources/order-shipping-method_tkggvd.jpg)
...
The Switchyard application passes the `data` property to the Fulfillment Module when fulfilling items.
