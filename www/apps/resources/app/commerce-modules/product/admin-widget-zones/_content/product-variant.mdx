...
This injection zone is only available after [Switchyard v2.0.5](https://github.com/switchyard/medusa/releases/tag/v2.0.5).
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        ...
        Type `DetailWidgetProps<AdminProductVariant>` imported from `@switchyard/framework/types`
