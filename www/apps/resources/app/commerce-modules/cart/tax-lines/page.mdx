...
![A diagram showcasing the relation between other data models and the tax line models](https://res.cloudinary.com/dza7lstvk/image/upload/v1711534431/Switchyard%20Resources/cart-tax-lines_oheaq6.jpg)
...
![A diagram showing an example of calculating the subtotal of a line item using its taxes](https://res.cloudinary.com/dza7lstvk/image/upload/v1711535295/Switchyard%20Resources/cart-tax-inclusive_shpr3t.jpg)
