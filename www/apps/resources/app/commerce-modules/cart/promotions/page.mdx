...
![A diagram showcasing the relations between other data models and adjustment line models](https://res.cloudinary.com/dza7lstvk/image/upload/v1711534248/Switchyard%20Resources/cart-adjustments_k4sttb.jpg)
...
When using the Cart and Promotion modules together, such as in the Switchyard application, use the [computeActions method of the Promotion Module’s main service](/references/promotion/computeActions). It retrieves the actions of line items and shipping methods.
