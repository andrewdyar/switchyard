...
Switchyard has cart related features available out-of-the-box through the Cart Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Cart Module.
...
- [Cart Scoping](./links-to-other-modules/page.mdx): When used in the Switchyard application, Switchyard creates links to other Commerce Modules, scoping a cart to a sales channel, region, and a customer.
