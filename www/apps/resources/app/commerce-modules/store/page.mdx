...
Refer to the [Switchyard Admin User Guide](!user-guide!/settings/store) to learn how to manage your store using the dashboard.

</Note>

Switchyard has store related features available out-of-the-box through the Store Module. A [module](!docs!/learn/fundamentals/modules) is a standalone package that provides features for a single domain. Each of Switchyard's commerce features are placed in Commerce Modules, such as this Store Module.
