...
This recipe provides the general steps to build a multi-region store with Switchyard.
...
Switchyard comes with multi-regional support out of the box. This recipe explains how to benefit from Switchyard's features to create a multi-regional store.

---

## Multi-Region Setup

In Switchyard, you can create unlimited regions in your store. Each region has configurations managed through the Switchyard Admin or the Admin REST APIs.
...
During checkout, Switchyard calculates the taxes using the tax region settings of the customer's region and selected country in their shipping address.

<CardList items={[
  {
    href: "!user-guide!/settings/tax-regions",
    title: "Using Switchyard Admin",
    text: "Learn how to manage tax regions in the Switchyard Admin",
    icon: UsersSolid,
  },
  {
...
Switchyard provides official module providers for payment and fulfillment. You can also create custom module providers.

<CardList itemsPerRow={2} items={[
  {
    href: "!user-guide!/settings/regions",
    title: "Manage Payment Providers in Switchyard Admin",
  ...
  },
  {
    ...
    title: "Manage Fulfillment Providers in Switchyard Admin",
...
Using the tax-inclusive feature, merchants can also specify prices including taxes per currency and region. Switchyard then calculates the tax amount applied to a line item in the cart based on the region's tax configurations.

<CardList items={[
  {
    href: "!user-guide!/products/variants#edit-product-variant-prices",
    title: "Setting Variant Prices in Switchyard Admin",
    text: "Learn how to set a variant's prices in Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
Switchyard's [Inventory](../../commerce-modules/inventory/page.mdx) and [Stock Location](../../commerce-modules/stock-location/page.mdx) Modules provide multi-warehouse features that allow merchants to manage inventory across different locations. Merchants then control which location an item in an order is fulfilled from, allowing them to keep a correct inventory count across locations and sales channels.

A multi-regional setup lets merchants manage their inventory through Switchyard across the different regions they serve. Customers are always shown accurate inventory information based on the location associated with their sales channel.

<CardList items={[
  {
    href: "!user-guide!/settings/locations-and-shipping/locations",
    title: "Manage Stock Locations",
    text: "Learn how to manage stock locations in the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
    href: "!user-guide!/inventory",
    title: "Manage Inventory",
    text: "Learn how to manage inventory in the Switchyard Admin.",
    icon: UsersSolid,
  },
]} />
...
<CardList items={[
  {
    ...
    text: "Learn how to create a module in Switchyard.",
    icon: AcademicCapSolid,
  },
  {
