...
<Prerequisites
  items={[
    {
      text: "Switchyard backend with ticket booking functionality",
      link: "../page.mdx",
    },
    {
...
![Preview of the seat selection on the product page](https://res.cloudinary.com/dza7lstvk/image/upload/v1757422831/Switchyard%20Resources/CleanShot_2025-09-09_at_15.59.33_2x_afkysa.png)
...
So, if your Switchyard application's directory is `medusa-ticketing`, you can find the storefront by going back to the parent directory and changing to the `medusa-ticketing-storefront` directory:
...
This functionality is supported by the Switchyard APIs, but you need to update the `addToCart` function in the storefront to accept and send metadata.
...
Now, the `addToCart` function accepts an optional `metadata` property and sends it to the Switchyard backend when creating a line item.
...
![Preview of the date selector component](https://res.cloudinary.com/dza7lstvk/image/upload/v1757495634/Switchyard%20Resources/CleanShot_2025-09-10_at_12.13.25_2x_adyjpu.png)
...
import { HttpTypes } from "@switchyard/types"
import { Button, Calendar, Label, IconButton, toast } from "@switchyard/ui"
...
- `product`: The Switchyard product to select a date for.
...
![Preview of the seat selector component](https://res.cloudinary.com/dza7lstvk/image/upload/v1757496623/Switchyard%20Resources/CleanShot_2025-09-10_at_12.30.07_2x_ylhhk1.png)
...
import { TicketProductSeatsData } from "@lib/util/ticket-product"
import { Tooltip, TooltipProvider } from "@switchyard/ui"
import { HttpTypes } from "@switchyard/types"
...
- `product`: The Switchyard product to select seats for.
...
To test the product page in the Next.js Starter Storefront, run the following command in the Switchyard application's directory:
...
![Product page for a ticket product with date selector](https://res.cloudinary.com/dza7lstvk/image/upload/v1757498728/Switchyard%20Resources/CleanShot_2025-09-10_at_13.05.15_2x_ktdgil.png)
...
![Seat selection modal on the product page](https://res.cloudinary.com/dza7lstvk/image/upload/v1757496623/Switchyard%20Resources/CleanShot_2025-09-10_at_12.30.07_2x_ylhhk1.png)
...
To test the latest cart and checkout changes, start both the Switchyard application and the Next.js Starter Storefront.
...
![Checkout page with three steps: Billing Address, Payment, and Review](https://res.cloudinary.com/dza7lstvk/image/upload/v1757500461/Switchyard%20Resources/CleanShot_2025-09-10_at_13.34.07_2x_bkevfs.png)
...
![Order confirmation page showing billing details](https://res.cloudinary.com/dza7lstvk/image/upload/v1757504448/Switchyard%20Resources/CleanShot_2025-09-10_at_14.40.34_2x_pwfyyf.png)
...
![Order confirmation page showing selected seats and show date for ticket items](https://res.cloudinary.com/dza7lstvk/image/upload/v1757504846/Switchyard%20Resources/CleanShot_2025-09-10_at_14.47.16_2x_mfnh3f.png)
