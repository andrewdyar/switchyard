...
import { AcademicCapSolid, UsersSolid } from "@switchyard/icons"
...
This recipe provides the general steps to implement a B2B store with Switchyard.

<Note title="Tip">

Switchyard has a ready-to-use B2B starter that you install and use in [this GitHub repository](https://github.com/switchyard/b2b-starter-medusa).
...
Switchyard’s Commerce Modules, including [Sales Channel](../../commerce-modules/sales-channel/page.mdx), [Customer](../../commerce-modules/), and [Pricing](../../commerce-modules/pricing/page.mdx) modules enable this setup out-of-the-box:
...
In addition, Switchyard’s extensible architecture and Framework for customization allow you to scope existing and custom features to specific customer groups or sales channels.

<Note title="Related use-case">

[Visionary: Frictionless B2B ecommerce with Switchyard](https://switchyard.com/blog/visionary/)
...
You can create a sales channel through the Switchyard Admin or Admin REST APIs.

<CardList items={[
  {
    href: "!user-guide!/settings/sales-channels",
    title: "Using Switchyard Admin",
    text: "Create the sales channel using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
So, if you use the publishable API key associated with the B2B sales channel in your storefront, the Switchyard server will only return products that are available in the B2B sales channel.

You can create a publishable API key through the Switchyard Admin or the Admin REST APIs, then associate it with the B2B sales channel. Then, you can use this key when developing your B2B storefront.
...
<CardList items={[
  {
    ...
    title: "Using Switchyard Admin",
    text: "Create the API key using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
<CardList items={[
  {
    ...
    title: "Using Switchyard Admin",
    text: "Associate the key with the sales channel using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
You can create new products or add existing ones to the B2B sales channel using the Switchyard Admin or Admin REST APIs.
...
<CardList items={[
  {
    ...
    title: "Using Switchyard Admin",
    text: "Create the products using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
<CardList items={[
  {
    ...
    title: "Using Switchyard Admin",
    text: "Create customers using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
<CardList items={[
  {
    ...
    title: "Using Switchyard Admin",
    text: "Assign customer to groups using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
You can create a price list using the Switchyard Admin or the Admin REST APIs. Make sure to set the B2B customer group(s) as a condition.

<CardList items={[
  {
    href: "!user-guide!/price-lists/create",
    title: "Using Switchyard Admin",
    text: "Create price list using the Switchyard Admin.",
    icon: UsersSolid,
  },
  {
...
- **UI Routes**: Adding new pages to the Switchyard Admin, such as a page to manage companies and employees.
- **Settings Pages**: Adding new pages to the Switchyard Admin settings, such as a page to manage company settings.
...
Switchyard provides a Next.js Starter Storefront to use with your application. You can customize it for your B2B use case, such as adding a login page for B2B customers or expanding the profile page to show the company associated with the customer.
