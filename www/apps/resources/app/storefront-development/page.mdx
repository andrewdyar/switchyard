...
The Switchyard application is made up of a Node.js server and an admin dashboard. The storefront is installed, built, and hosted separately from the Switchyard application, providing you with the flexibility to choose the frontend tech stack that you and your team are proficient in, and implement unique design systems and user experience. 

You can build your storefront from scratch, or build it on top of the [Next.js Starter storefront](../nextjs-starter/page.mdx). This section of the documentation provides guides to help you build a storefront from scratch for your Switchyard application.

<Note>

Learn more about Switchyard's architecture in [this documentation](!docs!/learn/introduction/architecture).

</Note>

## Who Should Follow These Guides?

These guides are for developers who want to build a storefront for their Switchyard application. That includes:
...
All guides under this documentation section use the [JS SDK](../js-sdk/page.mdx) to interact with the Switchyard application's Store API Routes. The JS SDK is a NPM package that facilitates interacting with the backend's REST APIs. You can use it in any JavaScript framework, such as Next.js, React, Vue, or Angular.
