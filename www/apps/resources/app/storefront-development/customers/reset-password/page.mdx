...
Before [Switchyard v2.6](https://github.com/switchyard/medusa/releases/tag/v2.6), you passed the token as a query parameter. Now, you must pass it in the `Authorization: Bearer` header.
