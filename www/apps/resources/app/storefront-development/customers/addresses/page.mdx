...
export const highlights = [
  ...
  ["27", "count", "The total number of addresses in the Switchyard application."],
...
The request also returns the `count` field, which is the total number of addresses in the Switchyard application. You can use it to check if there are more addresses to retrieve.
