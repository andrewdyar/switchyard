...
export const metadata = {
  title: `Manage Invites in Switchyard Admin`,
}
...
Make sure you've set up [Switchyard Emails](!cloud!/emails) in your Cloud project to send admin user invite emails. Switchyard Emails is a managed email service that allows you to send transactional emails with zero configuration.
