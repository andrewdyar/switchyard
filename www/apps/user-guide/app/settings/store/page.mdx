...
export const metadata = {
  title: `Manage Store in Switchyard Admin`,
}
...
In the store's settings, you can also manage a currency's tax-inclusive price setting. During checkout, after Switchyard calculates the tax of a product or shipping, it will either:
