...
export const metadata = {
  title: `Manage Shipping Option Types in Switchyard Admin`,
}

# {metadata.title}

In this guide, you’ll learn what shipping option types are and how to manage them in the Switchyard Admin.

<Note>

The settings page for Shipping Option Types was added in [Switchyard v2.10.0](https://github.com/switchyard/medusa/releases/tag/v2.10.0).
...
By default, Switchyard comes with two shipping option types: "Standard" and "Express". You can manage these types or create new ones to better fit your business needs.
