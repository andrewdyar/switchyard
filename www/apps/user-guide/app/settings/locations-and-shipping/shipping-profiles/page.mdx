...
export const metadata = {
  title: `Manage Shipping Profiles in Switchyard Admin`,
}

# {metadata.title}

In this guide, you’ll learn what shipping profiles are and how to manage them in the Switchyard Admin.
