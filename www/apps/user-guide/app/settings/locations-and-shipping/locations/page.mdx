...
import { EllipsisHorizontal, TaxExclusive, TaxInclusive, ArrowsPointingOut, Plus } from "@switchyard/icons"

export const metadata = {
  title: `Manage Locations in Switchyard Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to manage the stock locations using the Switchyard Admin.
