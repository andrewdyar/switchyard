...
export const metadata = {
  title: `Manage Regions in Switchyard Admin`,
}
...
A region has a tax-inclusive pricing setting that determines how taxes are added to prices for the region. During checkout, after Switchyard calculates the tax of a product or shipping, it will either:
