...
export const metadata = {
  title: `Manage Publishable API Keys in Switchyard Admin`,
}

# {metadata.title}

In this guide, you'll learn how to create and manage publishable API keys in the Switchyard Admin.
...
To view the publishable API keys in the Switchyard Admin, go to Settings -> Publishable API Keys.
