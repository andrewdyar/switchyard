...
import { EllipsisHorizontal, ArrowUpRightOnBox } from "@switchyard/icons"
import { Table } from "docs-ui"

export const metadata = {
  title: `View Workflow Executions in Switchyard Admin`,
}

# {metadata.title}

In this guide, you'll learn how to view workflow executions in the Switchyard Admin.

<Note>

This guide is primarily useful for developers and technical teams building and debugging customizations of a Switchyard application.
...
When you execute a workflow, Switchyard runs the steps in sequence to complete the task. If you've configured the workflow to store its executions in the database as explained in the [Store Workflow Executions guide](!docs!/learn/fundamentals/workflows/store-executions), you can view the workflow's executions and their details in the Switchyard Admin. This is useful for debugging workflows and ensuring they run as expected.

---

## View Workflow Executions

To view workflow executions, go to Settings → Workflows. There, you'll find a list of custom and Switchyard workflows that have been executed and are stored in the database. You can search through the list to find the one you're looking for.
