...
export const metadata = {
  title: `Manage Profile in Switchyard Admin`,
}
...
4. In the side window that opens, you can edit your first and last name, and the Switchyard Admin dashboard language. This only changes the language of the admin interface, not the language of the store. It also doesn't change the language for other users in the admin.
