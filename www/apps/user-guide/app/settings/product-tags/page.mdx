...
export const metadata = {
  title: `Manage Product Tags in Switchyard Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to manage product tags in the Switchyard Admin.
...
Management of product tag metadata was added in [Switchyard v2.10.0](https://github.com/switchyard/medusa/releases/tag/v2.10.0).
