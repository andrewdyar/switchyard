...
export const metadata = {
  title: `Manage Refund Reasons in Switchyard Admin`,
}
...
Refund reason management is available from [Switchyard Admin v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0). If you don't see the Refund Reasons option in your Switchyard Admin, request your technical team to [upgrade your Switchyard application](!docs!/learn/update).
...
Switchyard adds some default refund reasons to your store. You can use or [delete](#delete-a-refund-reason) them.
