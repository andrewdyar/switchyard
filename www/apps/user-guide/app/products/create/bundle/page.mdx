...
export const metadata = {
  title: `Create Bundle Product in Switchyard Admin`,
}
...
Switchyard supports variants with inventory kits, which is a collection of inventory items that make up the variant. To create a bundle product, you create a product with a variant that has an inventory kit of each product variant's inventory items.
