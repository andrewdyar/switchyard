...
export const metadata = {
  title: `Create Multi-Part Product in Switchyard Admin`,
}
...
Switchyard supports variants with inventory kits, which is a collection of inventory items that make up the variant's part. In addition, the variant can require a specific quantity of each inventory item to be available in stock.
