...
import { ArrowDownTray, Trash, BellAlert, EllipsisHorizontal } from "@switchyard/icons"
import { Prerequisites, Table } from "docs-ui"

export const metadata = {
  title: `Import Products in Switchyard Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to import products into your Switchyard store.

## Import Products from a CSV File

If you're migrating from another commerce platform, or from Switchyard v1, you can import products into Switchyard using a CSV file.

When you import the CSV file, Switchyard will either create or update products based on the CSV file you upload.
...
<Table>
  ...
  <Table.Body>
    ...
    <Table.Row>
      ...
      <Table.Cell>Whether Switchyard manages the variant's inventory. Can be `true` or `false`.</Table.Cell>
    </Table.Row>
    <Table.Row>
