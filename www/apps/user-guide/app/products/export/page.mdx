...
import { BellAlert, ArrowDownTray } from "@switchyard/icons"

export const metadata = {
  title: `Export Products in Switchyard Admin`,
}

# {metadata.title}

In this guide, you’ll learn how to export all products in your Switchyard store.
