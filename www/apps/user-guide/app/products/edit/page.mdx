...
import { ArrowUpRightOnBox, EllipsisHorizontal, EllipsisVertical, ThumbnailBadge } from "@switchyard/icons"
import { Table } from "docs-ui"

export const metadata = {
  title: `Edit Product in Switchyard Admin`,
}

# {metadata.title}

In this guide, you'll learn about editing a product's details in the Switchyard Admin.
...
Product variant media is available from [Switchyard Admin v2.11.2](https://github.com/switchyard/medusa/releases/tag/v2.11.2). If you don't see the "Manage associated variants" action, request your technical team to [upgrade your Switchyard application](!docs!/learn/update).
