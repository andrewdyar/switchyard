...
export const metadata = {
  title: `Create a Promotion in Switchyard Admin`,
}
...
If any of the fields are not visible in your admin, contact your technical team to [update your Switchyard version](!docs!/learn/update).
...
Free shipping promotions were added in [Switchyard v2.10.0](https://github.com/switchyard/medusa/releases/tag/v2.10.0).
...
The **Limit usage per** field is available from [Switchyard Admin v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0). If you don't see it, request your technical team to [upgrade your Switchyard application](!docs!/learn/update).
