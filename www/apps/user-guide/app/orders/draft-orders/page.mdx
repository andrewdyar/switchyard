...
export const metadata = {
  title: `Draft Orders in Switchyard Admin`,
}
...
The Draft Orders section of the Switchyard Admin allows you to create and manage draft orders on behalf of customers.
