...
export const metadata = {
  title: `Manage Order Payments in Switchyard Admin`,
}
...
Prior to [Switchyard v2.11.0](https://github.com/switchyard/medusa/releases/tag/v2.11.0), you were only able to refund a payment after creating a return or making an order change. From Switchyard v2.11.0 onwards, you can refund a payment directly from the order details page without needing to create a return or make an order change. If you're unable to refund a payment, contact your technical team to [update your Switchyard application](!docs!/learn/update).
...
By marking a positive outstanding amount as paid, you're capturing the payment without processing it through the associated payment provider. Instead, you handle capturing the payment outside of Switchyard.
...
If the payment link doesn't start with a domain or has a domain that doesn't match your storefront, refer your technical team to [this guide](!docs!/learn/configurations/switchyard.config#storefronturl) to set up the storefront domain.
