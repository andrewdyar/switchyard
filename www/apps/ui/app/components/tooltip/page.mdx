...
## Usage Outside Switchyard Admin with TooltipProvider

If you're using the `Tooltip` component in a project other than the Switchyard Admin, make sure to include the `TooltipProvider` somewhere up in your component tree:
