...
export const config: DocsConfig = {
  ...globalConfig,
  titleSuffix: "Switchyard UI",
  description:
    "Learn about Switchyard UI, A React package with primitives for building Switchyard applications. Explore components, hooks, colors, icons, and more.",
  baseUrl,
