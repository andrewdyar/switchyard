...
import { ArrowDownTray, ChevronUpDown, EllipsisHorizontal } from "@switchyard/icons"
...
Switchyard bills your organization monthly based on its plan and usage across projects. If you're in multiple organizations, each organization is billed separately.
...
You can reach out to `billing@switchyard.com` for assistance.
