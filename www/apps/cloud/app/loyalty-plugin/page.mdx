...
When you sign up for Cloud, you can access the Loyalty Plugin in your Switchyard applications deployed on Cloud.

The Loyalty Plugin is an add-on to your Cloud projects. It adds modules, API routes, workflows, and admin customizations that provide loyalty-related features to your Switchyard application.
...
![A screenshot of a gift card's details in the Switchyard Admin dashboard](https://res.cloudinary.com/dza7lstvk/image/upload/v1750235297/Cloud/CleanShot_2025-06-18_at_11.27.44_2x_zwrily.png)
...
Then, you can contact support for assistance in installing the Loyalty Plugin in your deployed Switchyard application.
