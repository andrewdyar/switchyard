...
After creating an organization, you can start deploying your Switchyard applications on Cloud.
...
To sign up for Cloud, go to [cloud.switchyard.com/signup](https://cloud.switchyard.com/signup?utm_source=docs&utm_medium=website&utm_campaign=cloud_signup_guide).
...
- **Where did you hear about Switchyard?**: Select an option from the dropdown menu. This helps us understand how users find out about Switchyard.
- **What are you building?**: Select an option from the dropdown menu. This helps us understand what users are building with Switchyard. If you don't see an option that fits your use case, select "Other" and provide more details in the text box that appears.
- **News and features**: Keep the switch enabled to receive updates about Switchyard, including new features, improvements, and other news. You can disable this option if you prefer not to receive such updates.
...
By default, the **Hobby** plan is selected. This plan is minimal and allows you to deploy a single Switchyard application that is suitable for development and testing purposes.
...
At this point, Switchyard will charge your card for the first month based on the plan you selected, and you will be redirected to your organization's Cloud dashboard.
...
- [Create projects](../projects/page.mdx) to deploy your Switchyard applications.
