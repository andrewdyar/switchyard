...
import { Plus, EllipsisHorizontal, ChevronUpDown } from "@switchyard/icons"
...
5. Once you're done, click the "Start your X/mo plan" button. Then, Switchyard will charge you for the plan you selected, create an organization, and redirect you to your organization's Cloud dashboard.
