...
import { BellAlert } from "@switchyard/icons"
...
Switchyard shows you notifications related to your Cloud organization, projects, environments, and deployments. These notifications keep you updated without needing to manually check for changes.
...
Switchyard also shows you toast notifications at the top right of the dashboard when you receive a new notification. These notifications appear momentarily and then disappear. They're helpful to quickly inform you about important updates.
