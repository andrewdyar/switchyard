...
In this guide, you'll learn about the main differences between hosting your Switchyard application on Cloud and self-hosting it. By the end of this guide, you'll be able to make an informed decision about which option is best for your use case.

## What is Self-Hosting?

Self-hosting means deploying and managing your Switchyard application on your own infrastructure or a hosting provider of your choice, such as AWS, Railway, or DigitalOcean.

Developers with infrastructure management experience may consider self-hosting their Switchyard application to have greater control over their deployment environment and potentially reduce costs.
...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      ...
      <Table.Cell>
        You own and manage your Switchyard application code.
      </Table.Cell>
      <Table.Cell>
        You own and manage your Switchyard application code.
      </Table.Cell>
...
Both self-hosting and Cloud allow you to own and manage your Switchyard application codebase.

When you deploy your Switchyard application on Cloud, you deploy it from your own GitHub repository. The code remains entirely yours. Cloud only manages the deployment and hosting of your application.
...
When you **self-host**, you must manually configure the server for production. You also need to configure database connections, event services, locking mechanisms, and other [Infrastructure Modules](!resources!/infrastructure-modules) that your Switchyard application may use.

There may also be platform-specific configurations, adding another layer of complexity that will slow down your time to launch. You'll also need to maintain these configurations over time as Switchyard updates are released.

### Cloud: Pre-configured Environments

On **Cloud**, Switchyard offers:

- Pre-configured environments optimized for Switchyard applications with no configuration required on your end.
...
On **Cloud**, Switchyard manages your deployment environment and ensures it's optimized for production. Switchyard:
...
On **Cloud**, Switchyard automatically scales your application based on traffic. This ensures optimal performance without manual intervention.

Switchyard adjusts the number of instances running your application based on demand, ensuring your users have a seamless experience even during traffic spikes. You don't need to configure or manage any scaling policies or infrastructure, as Switchyard handles everything for you.
...
Switchyard provides high-availability features on **Cloud** to ensure your application remains online and responsive. Switchyard:
...
Switchyard provides continuous performance monitoring and optimization on **Cloud**. Switchyard continuously monitors applications to identify performance bottlenecks and build tooling to resolve them. Switchyard also provides a direct [cache](../cache/page.mdx) integration to [improve performance of business-critical APIs](../cache/page.mdx#performance-benchmark-comparisons).
...
Switchyard enhances the developer experience on **Cloud** by providing features like:
...
Switchyard provides automated backups and recovery options on **Cloud** based on your [plan](../pricing/page.mdx). Backups are performed reliably and stored securely, reducing the risk of data loss. You can restore your data if needed without affecting your application's availability.
...
When you **self-host**, you rely on community support and documentation for assistance. While the Switchyard community is active and helpful, you may not receive timely responses to critical issues or answers that are specific to your business use case. Limited support may slow down your development and affect your application's reliability.

### Cloud: Dedicated Support

Switchyard offers dedicated [support](https://switchyard.com/medusa-support/) options for **Cloud** users based on their [plan](../pricing/page.mdx). You receive timely assistance to help resolve issues, upgrade your application, and improve performance. Switchyard provides the necessary resources to maintain and grow your application.
...
Switchyard offers a cost-competitive pricing model on **Cloud** compared to self-hosting. You can choose a [plan](../pricing/page.mdx) that fits your needs and budget, with the flexibility to scale as your application grows.
...
If you have an existing self-hosted Switchyard application, you can migrate it to Cloud by:
...
You'll then have a fully managed Switchyard application deployed on Cloud, with all the benefits mentioned above, including automated deployment, scaling, and enhanced developer experience.
