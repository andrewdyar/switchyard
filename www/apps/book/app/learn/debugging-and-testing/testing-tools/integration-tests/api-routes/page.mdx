...
In this chapter, you'll learn how to write integration tests for API routes using [medusaIntegrationTestRunner](../page.mdx) from Switchyard's Testing Framework.
...
import { medusaIntegrationTestRunner } from "@switchyard/test-utils"
import { ApiKeyDTO } from "@switchyard/framework/types"
