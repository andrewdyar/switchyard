...
An Infrastructure Module implements features and mechanisms related to the Switchyard application’s architecture and infrastructure.

Since modules are interchangeable, you have more control over Switchyard’s architecture. For example, you can choose to use Memcached for event handling instead of Redis.
...
![Diagram illustrating how the modules connect to third-party services](https://res.cloudinary.com/dza7lstvk/image/upload/v1759762284/Switchyard%20Book/service-infra_k3fcy0.jpg)
...
Refer to the [Infrastructure Modules reference](!resources!/infrastructure-modules) for a list of Switchyard’s Infrastructure Modules, available modules to install, and how to create an Infrastructure Module.
