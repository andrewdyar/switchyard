...
![Module Directory Structure Example](https://res.cloudinary.com/dza7lstvk/image/upload/v1714379976/Switchyard%20Book/modules-dir-overview_nqq7ne.jpg)
...
- `loaders`: Holds the [script files to run on the application's startup](../loaders/page.mdx) when Switchyard loads the module.