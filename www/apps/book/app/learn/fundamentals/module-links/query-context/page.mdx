...
Switchyard also uses Query Context to [retrieve product variants' prices based on the customer's currency](!resources!/commerce-modules/product/guides/price).
...
import { SwitchyardContext, SwitchyardService } from "@switchyard/framework/utils"
