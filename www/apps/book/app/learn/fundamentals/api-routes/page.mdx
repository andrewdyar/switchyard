...
You can create an API route in a TypeScript or JavaScript file under the `src/api` directory of your Switchyard application. The file’s name must be `route.ts` or `route.js`. 

![Example of API route in the application's directory structure](https://res.cloudinary.com/dza7lstvk/image/upload/v1732808645/Switchyard%20Book/route-dir-overview_dqgzmk.jpg)
...
To test the API route above, start the Switchyard application:
