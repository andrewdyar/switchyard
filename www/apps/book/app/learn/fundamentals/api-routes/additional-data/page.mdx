...
export const metadata = {
  title: `${pageNumber} Pass Additional Data to Switchyard's API Route`,
}

# {metadata.title}

In this chapter, you'll learn how to pass additional data in requests to Switchyard's API Route.

## Why Pass Additional Data?

Some of Switchyard's API Routes accept an `additional_data` parameter whose type is an object. The API Route passes the `additional_data` to the workflow, which in turn passes it to its hooks.
...
- Collections
    - [Create Collection](https://docs.switchyard.com/api/admin#collections_postcollections)
    - [Update Collection](https://docs.switchyard.com/api/admin#collections_postcollectionsid)
- Customers
...
- Product Tags
    - [Create Product Tag](https://docs.switchyard.com/api/admin#product-tags_postproducttags)
    - [Update Product Tag](https://docs.switchyard.com/api/admin#product-tags_postproducttagsid)
- Product Types
    - [Create Product Type](https://docs.switchyard.com/api/admin#product-types_postproducttypes)
    - [Update Product Type](https://docs.switchyard.com/api/admin#product-types_postproducttypesid)
- Promotions
