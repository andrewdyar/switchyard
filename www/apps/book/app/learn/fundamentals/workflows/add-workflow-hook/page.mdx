...
Refer to the [Workflow Hooks](../workflow-hooks/page.mdx) chapter to learn what a workflow hook is and how to consume Switchyard's workflow hooks.

</Note>

## When to Expose a Hook?

Switchyard exposes hooks in many of its workflows to allow you to inject custom functionality.
...
You can also access the Switchyard container in the hook handler to perform actions like using Query or module services.
