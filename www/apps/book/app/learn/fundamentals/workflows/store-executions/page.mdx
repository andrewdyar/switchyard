...
Switchyard doesn't store your workflow's execution details by default. However, you can configure a workflow to keep its execution details stored in the database.
...
You can view stored workflow executions from the Switchyard Admin dashboard by going to Settings -> Workflows.
