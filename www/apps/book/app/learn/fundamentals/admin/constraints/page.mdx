...
Widget and UI route components must be created as arrow functions. Otherwise, Switchyard doesn't register them correctly.
...
A widget zone's value must be wrapped in double or single quotes. It can't be a template literal or a variable. Otherwise, Switchyard doesn't register the widget correctly.
