...
![Diagram illustrating the relation between user and email records in the database](https://res.cloudinary.com/dza7lstvk/image/upload/v1726733492/Switchyard%20Book/one-to-one_cj5np3.jpg)
...
![Diagram illustrating the relation between a store and product records in the database](https://res.cloudinary.com/dza7lstvk/image/upload/v1726733937/Switchyard%20Book/one-to-many_d6wtcw.jpg)
...
The `pivotTable`, `joinColumn`, and `inverseJoinColumn` properties are only available after [Switchyard v2.0.7](https://github.com/switchyard/medusa/releases/tag/v2.0.7).

</Note>

<Note>

Following [Switchyard v2.1.0](https://github.com/switchyard/medusa/releases/tag/v2.1.0), if `pivotTable`, `joinColumn`, and `inverseJoinColumn` aren't specified on either model, the owner is decided based on alphabetical order. So, in the example above, the `Order` data model would be the owner.
...
![Diagram illustrating the relation between order and product records in the database](https://res.cloudinary.com/dza7lstvk/image/upload/v1726734269/Switchyard%20Book/many-to-many_fzy5pq.jpg)
