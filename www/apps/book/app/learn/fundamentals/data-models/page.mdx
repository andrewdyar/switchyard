...
![Updated directory overview after adding the data model](https://res.cloudinary.com/dza7lstvk/image/upload/v1732806790/Switchyard%20Book/blog-dir-overview-1_jfvovj.jpg)
...
After you create a data model in a module, then [register that module in your Switchyard configurations](../modules/page.mdx#4-add-module-to-medusas-configurations), you must generate a migration to create the data model's table in the database.
...
For example, to generate a migration for the Blog Module, run the following command in your Switchyard application's directory:
