export const metadata = {
  title: `Translate Switchyard Admin`,
}

# {metadata.title}

The Switchyard Admin supports multiple languages, with the default being English. In this documentation, you'll learn how to contribute to the community by translating the Switchyard Admin to a language you're fluent in.
...
Check out the translated languages either in the admin dashboard's settings or on [GitHub](https://github.com/switchyard/medusa/blob/develop/packages/admin/dashboard/src/i18n/languages.ts).
...
1. Clone the [Switchyard monorepository](https://github.com/switchyard/medusa) to your local machine:

```bash
git clone https://github.com/switchyard/medusa.git
```
