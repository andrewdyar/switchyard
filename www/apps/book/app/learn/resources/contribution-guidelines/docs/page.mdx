...
Thank you for your interest in contributing to the documentation! You will be helping the open source community and other developers interested in learning more about Switchyard and using it.
...
This guide is specific to contributing to the documentation. If you’re interested in contributing to Switchyard’s codebase, check out the [contributing guidelines in the Switchyard GitHub repository](https://github.com/switchyard/medusa/blob/develop/CONTRIBUTING.md).

</Note>

## What Can You Contribute?

You can contribute to the Switchyard documentation in the following ways:
...
- Additions to the documentation. If you think a documentation page can be useful to other developers, you can contribute by adding it.
    - Make sure to open an issue first in the [medusa repository](https://github.com/switchyard/medusa) to confirm that you can add that documentation page.
...
Switchyard's documentation projects are all part of the documentation `yarn` workspace, which you can find in the [medusa repository](https://github.com/switchyard/medusa) under the `www` directory.
...
- `apps`: this directory holds the different documentation websites and projects. All projects are built with [Next.js 15](https://nextjs.org/).
  - `book`: includes the codebase and content for the [main Switchyard documentation](../../../page.mdx).
  ...
  - `ui`: includes the codebase and content for the [Switchyard UI documentation](!ui!).
  - `user-guide`: includes the codebase and content for the [user guide documentation](!user-guide!).
  - `cloud`: includes the codebase and content for the [Switchyard Cloud documentation](!cloud!).
...
### Switchyard Main Docs Content

The content of the Switchyard main docs are under the `www/apps/book/app` directory.

### Switchyard Resources Content
...
### Switchyard UI Documentation

The content of the Switchyard UI documentation are located under the `www/apps/ui/app` directory. They are MDX files.
...
If you’re adding a new page or contributing to the codebase, fork the repository, create a new branch, and make all changes necessary in your repository. Then, once you’re done, create a PR in the Switchyard repository.
...
Switchyard uses [Vale](https://vale.sh/) to lint documentation pages and perform checks on incoming PRs into the repository.
...
# to lint content for the Switchyard UI documentation
...
Switchyard supports Node versions 14 and 16.
...
Switchyard uses ESlint to lint code blocks both in the content and the code base of the documentation apps.
