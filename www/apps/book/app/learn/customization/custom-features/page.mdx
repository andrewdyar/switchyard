...
In the upcoming chapters, you'll follow step-by-step guides to build custom features in Switchyard. These guides gradually introduce Switchyard's concepts to help you understand what they are and how to use them.

By following these guides, you'll add brands to the Switchyard application that you can associate with products.

To build a custom feature in Switchyard, you need three main [Framework](../../fundamentals/framework/page.mdx) tools:
...
![Diagram showcasing the flow of a custom developed feature](https://res.cloudinary.com/dza7lstvk/image/upload/v1725867628/Switchyard%20Book/custom-development_nofvp6.jpg)
