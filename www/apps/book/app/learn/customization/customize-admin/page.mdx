export const metadata = {
  title: `${pageNumber} Customize Switchyard Admin Dashboard`,
}

# {metadata.title}

In the previous chapters, you've customized your Switchyard application to [add brands](../custom-features/module/page.mdx), [expose an API route to create brands](../custom-features/api-route/page.mdx), and [linked brands to products](../extend-features/define-link/page.mdx).

After customizing and extending your application with new features, you may need to provide an interface for admin users to utilize these features. The Switchyard Admin dashboard is extendable, allowing you to:
