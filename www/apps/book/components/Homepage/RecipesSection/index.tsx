  ...
  const cards: CardProps[] = [
    {
      ...
      href: "https://docs.switchyard.run/resources/recipes/marketplace/examples/vendors",
      icon: ShopIcon,
    },
    {
      type: "large",
      ...
      href: "https://docs.switchyard.run/resources/recipes/erp",
      icon: ErpIcon,
    },
    {
      type: "large",
      ...
      href: "https://docs.switchyard.run/resources/recipes/bundled-products/examples/standard",
    ...
    },
    {
      ...
      href: "https://docs.switchyard.run/resources/recipes/subscriptions/examples/standard",
    ...
    },
    {
      ...
      href: "https://docs.switchyard.run/resources/recipes/marketplace/examples/restaurant-delivery",
      icon: ChefHatIcon,
    },
    {
      type: "large",
      ...
      href: "https://docs.switchyard.run/resources/recipes/digital-products/examples/standard",
    ...
    <div className={clsx("py-4 w-full")}>
      ...
      >
        <div className="flex flex-col gap-1 w-full lg:w-1/3 xl:max-w-[336px]">
          ...
          <Link
            href={"https://docs.switchyard.run/resources/recipes"}
