...
import { CircleMiniSolid } from "@switchyard/icons"
...
export const LearningPath = ({
  ...
  return (
    <div
      className={clsx(
        "rounded shadow-elevation-card-rest dark:shadow-elevation-card-rest-dark bg-switchyard-bg-subtle mt-docs_1.5 mb-docs_4",
        className
      )}
    >
      <div
