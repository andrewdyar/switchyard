...
export const Button = ({
  ...
  const variantClasses = {
    primary: [
      ...
      "disabled:bg-switchyard-bg-disabled disabled:shadow-button-neutral dark:disabled:shadow-button-neutral-dark",
    ...
    transparent: [
      ...
      "focus:bg-switchyard-bg-base focus:shadow-button-neutral-focused dark:focus:shadow-button-neutral-focused-dark",
