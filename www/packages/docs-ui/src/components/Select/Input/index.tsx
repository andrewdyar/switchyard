...
import { ChevronUpDown, XMarkMini } from "@switchyard/icons"
  ...
  return (
    <div
      className={clsx(
        ...
        "bg-switchyard-bg-field shadow-button-neutral dark:shadow-button-neutral-dark",
        "hover:bg-switchyard-bg-field-hover",
