...
export const AiAssistantChatWindowFooter = () => {
  return (
    <div
      className={clsx(
        "bg-switchyard-bg-component border-t border-medusa-border-base",
      ...
      <div className="flex items-center justify-end gap-docs_0.75">
        ...
        <div className="flex items-center gap-docs_0.5">
          ...
          <div className="flex items-center gap-[5px]">
            <Kbd className="bg-switchyard-bg-field-component border-medusa-border-strong w-[18px] h-[18px] inline-block p-0">
              ⇧
            </Kbd>
            <Kbd className="bg-switchyard-bg-field-component border-medusa-border-strong w-[18px] h-[18px] inline-block p-0">
              ↵
