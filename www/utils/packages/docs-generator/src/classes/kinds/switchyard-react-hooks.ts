...
} from "../../utils/switchyard-react-utils.js"

/**
 * Docblock generate for switchyard-react hooks. Since hooks are essentially functions,
 * it extends the {@link FunctionKindGenerator} class.
 */
class SwitchyardReactHooksKindGenerator extends FunctionKindGenerator {
  public name = "switchyard-react"
  /**
  ...
  /**
   * Retrieves the docblock of the switchyard-react hook or mutation.
   *
...
export default SwitchyardReactHooksKindGenerator
