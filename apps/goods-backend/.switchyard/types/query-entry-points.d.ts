import "@switchyard/framework/types"
...
export type InventoryGroup = {
  ...
  aisle_number: Maybe<Scalars['Int']['output']>;
  bay_number: Maybe<Scalars['Int']['output']>;
  shelf_number: Maybe<Scalars['Int']['output']>;
  slot_number: Maybe<Scalars['Int']['output']>;
  location_code: Maybe<Scalars['String']['output']>;
  parent_group_id: Maybe<Scalars['String']['output']>;
  parent_group: Maybe<InventoryGroup>;
  group_children: Array<Maybe<InventoryGroup>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at: Maybe<Scalars['DateTime']['output']>;
};
